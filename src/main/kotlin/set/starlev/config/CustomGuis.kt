...
class FilterGui(private val parent: Screen? = null) : Screen(Component.literal("Фильтры сообщений")) {
    ...
    override fun render(guiGraphics: GuiGraphics, mouseX: Int, mouseY: Int, partialTick: Float) {
        ...
        guiGraphics.fill(centerX - 120, addY, centerX - 118, addY + 20, 0xFF55FF55.toInt()) // Зеленая линия
        ...
        for ((index, filter) in filters.withIndex()) {
            ...
            if (y + itemHeight < height - 40) {
                ...
                guiGraphics.fill(centerX - 120, y, centerX - 118, y + 20, 0xFF55FFFF.toInt())
...
class BindsGui(private val parent: Screen? = null) : Screen(Component.literal("Бинды клавиш")) {
    ...
    override fun render(guiGraphics: GuiGraphics, mouseX: Int, mouseY: Int, partialTick: Float) {
        ...
        guiGraphics.fill(centerX - 130, addY, centerX - 128, addY + 25, 0xFF55FF55.toInt()) // Зеленая линия
        ...
        CustomBindManager.binds.entries.forEachIndexed { index, entry ->
            ...
            if (y + itemHeight < height - 40) {
                ...
                guiGraphics.fill(centerX - 130, y, centerX - 128, y + 25, 0xFF55FFFF.toInt())
