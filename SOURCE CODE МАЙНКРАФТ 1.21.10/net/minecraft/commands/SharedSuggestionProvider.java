...
public interface SharedSuggestionProvider {
   ...
   default void suggestRegistryElements(HolderLookup<?> var1, SharedSuggestionProvider.ElementSuggestionType var2, SuggestionsBuilder var3) {
   ...
   static <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> var0, SuggestionsBuilder var1, ResourceKey<? extends Registry<?>> var2, SharedSuggestionProvider.ElementSuggestionType var3) {
      Object var5 = var0.getSource();
      if (var5 instanceof SharedSuggestionProvider) {
         SharedSuggestionProvider var4 = (SharedSuggestionProvider)var5;
