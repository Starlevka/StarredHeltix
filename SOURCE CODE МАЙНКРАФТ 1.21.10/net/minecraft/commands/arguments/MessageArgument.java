...
public class MessageArgument implements SignedArgument<MessageArgument.Message> {
   ...
   // $FF: synthetic method
   public Object parse(final StringReader param1, @Nullable final Object param2) throws CommandSyntaxException {
   ...
   public static record Message(String text, MessageArgument.Part[] parts) {
      ...
      public Message(String param1, MessageArgument.Part[] param2) {
         super();
         this.text = var1;
         this.parts = var2;
      }
      ...
      public MessageArgument.Part[] parts() {
         return this.parts;
      }
   }

   public static record Part(int start, int end, EntitySelector selector) {
      public Part(int param1, int param2, EntitySelector param3) {
         super();
         this.start = var1;
         this.end = var2;
         this.selector = var3;
