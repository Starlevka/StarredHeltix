...
public class ComponentPredicateParser {
   ...
   static class ElementLookupRule<T, C, P> extends ResourceLookupRule<ComponentPredicateParser.Context<T, C, P>, T> {
      ElementLookupRule(NamedRule<StringReader, ResourceLocation> var1, ComponentPredicateParser.Context<T, C, P> var2) {
         super(var1, var2);
      }
   ...
   private static class TagLookupRule<T, C, P> extends ResourceLookupRule<ComponentPredicateParser.Context<T, C, P>, T> {
      TagLookupRule(NamedRule<StringReader, ResourceLocation> var1, ComponentPredicateParser.Context<T, C, P> var2) {
         super(var1, var2);
      }
   ...
   static class ComponentLookupRule<T, C, P> extends ResourceLookupRule<ComponentPredicateParser.Context<T, C, P>, C> {
      ComponentLookupRule(NamedRule<StringReader, ResourceLocation> var1, ComponentPredicateParser.Context<T, C, P> var2) {
         super(var1, var2);
      }
   ...
   static class PredicateLookupRule<T, C, P> extends ResourceLookupRule<ComponentPredicateParser.Context<T, C, P>, P> {
      PredicateLookupRule(NamedRule<StringReader, ResourceLocation> var1, ComponentPredicateParser.Context<T, C, P> var2) {
         super(var1, var2);
      }
