...
public class ComponentArgument extends ParserBasedArgument<Component> {
   ...
   public static final DynamicCommandExceptionType ERROR_INVALID_COMPONENT = new DynamicCommandExceptionType((var0) -> {
   ...
   public static Component getResolvedComponent(CommandContext<CommandSourceStack> var0, String var1, @Nullable Entity var2) throws CommandSyntaxException {
      return ComponentUtils.updateForEntity((CommandSourceStack)var0.getSource(), (Component)getRawComponent(var0, var1), var2, 0);
   }
