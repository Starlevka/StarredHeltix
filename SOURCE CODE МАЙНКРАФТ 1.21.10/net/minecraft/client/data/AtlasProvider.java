...
public class AtlasProvider implements DataProvider {
   ...
   private static final Map<String, ResourceLocation> TRIM_PALETTE_VALUES = (Map)extractAllMaterialAssets().collect(Collectors.toMap(MaterialAssetGroup.AssetInfo::suffix, (var0) -> {
      return ResourceLocation.withDefaultNamespace("trims/color_palettes/" + var0.suffix());
   }));
