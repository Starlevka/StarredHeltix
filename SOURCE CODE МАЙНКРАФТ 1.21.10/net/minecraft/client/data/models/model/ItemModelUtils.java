...
public class ItemModelUtils {
   ...
   public static ItemModel.Unbaked inOverworld(ItemModel.Unbaked var0, ItemModel.Unbaked var1) {
      return select(new ContextDimension(), var1, (SelectItemModel.SwitchCase[])(when((Object)Level.OVERWORLD, var0)));
   }
   ...
   public static ItemModel.Unbaked isXmas(ItemModel.Unbaked var0, ItemModel.Unbaked var1) {
      return select(LocalTime.create("MM-dd", "", Optional.empty()), var1, (List)List.of(when(List.of("12-24", "12-25", "12-26"), var0)));
   }
}
