...
public class ItemModelGenerators {
   ...
   private void generateTrimmableItem(Item var1, ResourceKey<EquipmentAsset> var2, ResourceLocation var3, boolean var4) {
      ...
      ItemModelGenerators.TrimMaterialData var10;
      ...
      for(Iterator var9 = TRIM_MATERIAL_MODELS.iterator(); var9.hasNext(); var8.add(ItemModelUtils.when((Object)var10.materialKey, var13))) {
         var10 = (ItemModelGenerators.TrimMaterialData)var9.next();
   ...
   private static ItemModel.Unbaked createFlatModelDispatch(ItemModel.Unbaked var0, ItemModel.Unbaked var1) {
      return ItemModelUtils.select(new DisplayContext(), var1, (SelectItemModel.SwitchCase[])(ItemModelUtils.when(List.of(ItemDisplayContext.GUI, ItemDisplayContext.GROUND, ItemDisplayContext.FIXED, ItemDisplayContext.ON_SHELF), var0)));
   }
   ...
   public static record TrimMaterialData(MaterialAssetGroup assets, ResourceKey<TrimMaterial> materialKey) {
      ...
      public TrimMaterialData(MaterialAssetGroup param1, ResourceKey<TrimMaterial> param2) {
         super();
         this.assets = var1;
