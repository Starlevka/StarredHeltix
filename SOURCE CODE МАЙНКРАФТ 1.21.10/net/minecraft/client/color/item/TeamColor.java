...
public record TeamColor(int defaultColor) implements ItemTintSource {
   public static final MapCodec<TeamColor> MAP_CODEC = RecordCodecBuilder.mapCodec((var0) -> {
      return var0.group(ExtraCodecs.RGB_COLOR_CODEC.fieldOf("default").forGetter(TeamColor::defaultColor)).apply(var0, TeamColor::new);
   });

   public TeamColor(int param1) {
      super();
   ...
   public int calculate(ItemStack var1, @Nullable ClientLevel var2, @Nullable LivingEntity var3) {
      if (var3 != null) {
         ...
         if (var4 != null) {
            ChatFormatting var5 = var4.getColor();
