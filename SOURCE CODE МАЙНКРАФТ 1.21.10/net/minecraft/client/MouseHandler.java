...
public class MouseHandler {
            ...
            if (this.minecraft.screen == null) {
               ...
               if (var6) {
                  ...
                  try {
                     ...
                     boolean var20 = var14 - this.lastClickTime < 250L && this.lastClickButton == var13.button();
   ...
   public void fillMousePositionDetails(CrashReportCategory var1, Window var2) {
      ...
      var1.setDetail("Screen size", () -> {
         return String.format(Locale.ROOT, "Scaled: (%d, %d). Absolute: (%d, %d). Scale factor of %f", var2.getGuiScaledWidth(), var2.getGuiScaledHeight(), var2.getWidth(), var2.getHeight(), var2.getGuiScale());
      });
   }
