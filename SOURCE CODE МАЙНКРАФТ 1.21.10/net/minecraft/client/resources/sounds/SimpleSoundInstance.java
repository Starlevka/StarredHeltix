...
public class SimpleSoundInstance extends AbstractSoundInstance {
   ...
   public static SimpleSoundInstance forUI(SoundEvent var0, float var1, float var2) {
      return new SimpleSoundInstance(var0.location(), SoundSource.UI, var2, var1, SoundInstance.createUnseededRandom(), false, 0, SoundInstance.Attenuation.NONE, 0.0D, 0.0D, 0.0D, true);
   }

   public static SimpleSoundInstance forMusic(SoundEvent var0, float var1) {
      return new SimpleSoundInstance(var0.location(), SoundSource.MUSIC, var1, 1.0F, SoundInstance.createUnseededRandom(), false, 0, SoundInstance.Attenuation.NONE, 0.0D, 0.0D, 0.0D, true);
   }
   ...
   public static SimpleSoundInstance forLocalAmbience(SoundEvent var0, float var1, float var2) {
      return new SimpleSoundInstance(var0.location(), SoundSource.AMBIENT, var2, var1, SoundInstance.createUnseededRandom(), false, 0, SoundInstance.Attenuation.NONE, 0.0D, 0.0D, 0.0D, true);
   }
