...
public class ModelDiscovery {
   ...
   private ModelDiscovery.ModelWrapper getOrCreateModel(ResourceLocation var1) {
      return (ModelDiscovery.ModelWrapper)this.modelWrappers.computeIfAbsent(var1, this.uncachedResolver);
   }

   private ModelDiscovery.ModelWrapper createAndQueueWrapper(ResourceLocation var1, UnbakedModel var2) {
