...
public class MapTextureManager implements AutoCloseable {
   ...
   private MapTextureManager.MapInstance getOrCreateMapInstance(MapId var1, MapItemSavedData var2) {
      return (MapTextureManager.MapInstance)this.maps.compute(var1.id(), (var2x, var3) -> {
         if (var3 == null) {
            return new MapTextureManager.MapInstance(this, var2x, var2);
         } else {
   ...
   class MapInstance implements AutoCloseable {
      ...
      MapInstance(final MapTextureManager param1, final int param2, final MapItemSavedData param3) {
         super();
         this.data = var3;
         ...
         var1.textureManager.register(this.location, this.texture);
      }
