...
public class ServerPackManager {
   ...
   private void markExistingPacksAsRemoved(UUID var1) {
      ...
      while(var2.hasNext()) {
         ServerPackManager.ServerPackData var3 = (ServerPackManager.ServerPackData)var2.next();
   ...
   public void pushLocalPack(UUID var1, Path var2) {
      if (this.packPromptStatus == ServerPackManager.PackPromptStatus.DECLINED) {
         ...
         ServerPackManager.ServerPackData var4 = new ServerPackManager.ServerPackData(var1, var3, (HashCode)null);
   ...
   private ServerPackManager.ServerPackData findPackInfo(UUID var1) {
      ...
      ServerPackManager.ServerPackData var3;
      do {
         if (!var2.hasNext()) {
            return null;
         }

         var3 = (ServerPackManager.ServerPackData)var2.next();
   ...
   public void popAll() {
      ...
      while(var1.hasNext()) {
         ServerPackManager.ServerPackData var2 = (ServerPackManager.ServerPackData)var1.next();
         var2.setRemovalReasonIfNotSet(ServerPackManager.RemovalReason.SERVER_REMOVED);
      }
   ...
   private void onDownload(Collection<ServerPackManager.ServerPackData> var1, DownloadQueue.BatchResult var2) {
      Iterator var3;
      ServerPackManager.ServerPackData var4;
      if (!var2.failed().isEmpty()) {
         var3 = this.packs.iterator();

         while(var3.hasNext()) {
            var4 = (ServerPackManager.ServerPackData)var3.next();
   ...
   private boolean updateDownloads() {
      ...
      while(var3.hasNext()) {
         ServerPackManager.ServerPackData var4 = (ServerPackManager.ServerPackData)var3.next();
      ...
      if (!var1.isEmpty()) {
         ...
         while(var7.hasNext()) {
            ServerPackManager.ServerPackData var5 = (ServerPackManager.ServerPackData)var7.next();
   ...
   private void triggerReloadIfNeeded() {
      ...
      ServerPackManager.ServerPackData var5;
      while(var4.hasNext()) {
         var5 = (ServerPackManager.ServerPackData)var4.next();
      ...
      if (var1) {
         ...
         this.reloadConfig.scheduleReload(new PackReloadConfig.Callbacks() {
            public void onSuccess() {
               ...
               ServerPackManager.ServerPackData var2x;
               while(var1.hasNext()) {
                  var2x = (ServerPackManager.ServerPackData)var1.next();
            ...
            public void onFailure(boolean var1) {
               Iterator var2x;
               ServerPackManager.ServerPackData var3x;
               if (!var1) {
                  var2.clear();
                  var2x = ServerPackManager.this.packs.iterator();

                  while(var2x.hasNext()) {
                     var3x = (ServerPackManager.ServerPackData)var2x.next();
