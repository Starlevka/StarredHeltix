...
public class LayerDefinitions {
   ...
   public static Map<ModelLayerLocation, LayerDefinition> createRoots() {
      ...
      ArmorModelSet var2 = HumanoidModel.createArmorMeshSet(INNER_ARMOR_DEFORMATION, OUTER_ARMOR_DEFORMATION).map((var0x) -> {
         return LayerDefinition.create(var0x, 64, 32);
      });
      ArmorModelSet var3 = var2.map((var0x) -> {
         return var0x.apply(HumanoidModel.BABY_TRANSFORMER);
      });
      ArmorModelSet var4 = PlayerModel.createArmorMeshSet(INNER_ARMOR_DEFORMATION, OUTER_ARMOR_DEFORMATION).map((var0x) -> {
         return LayerDefinition.create(var0x, 64, 32);
      });
      ArmorModelSet var5 = PiglinModel.createArmorMeshSet(INNER_ARMOR_DEFORMATION, new CubeDeformation(1.02F)).map((var0x) -> {
         return LayerDefinition.create(var0x, 64, 32);
      });
      ArmorModelSet var6 = var5.map((var0x) -> {
         return var0x.apply(HumanoidModel.BABY_TRANSFORMER);
      });
      ...
      ModelLayers.ARMOR_STAND_SMALL_ARMOR.putFrom(var55.map((var0x) -> {
         return var0x.apply(HumanoidModel.BABY_TRANSFORMER);
      }), var0);
      ...
      ModelLayers.GIANT_ARMOR.putFrom(var2.map((var1x) -> {
         return var1x.apply(var61);
      }), var0);
      ...
      ModelLayers.HUSK_ARMOR.putFrom(var2.map((var1x) -> {
         return var1x.apply(var63);
      }), var0);
      var0.put(ModelLayers.HUSK_BABY, var1.apply(HumanoidModel.BABY_TRANSFORMER).apply(var63));
      ModelLayers.HUSK_BABY_ARMOR.putFrom(var3.map((var1x) -> {
         return var1x.apply(var63);
      }), var0);
      ...
      ModelLayers.WITHER_SKELETON_ARMOR.putFrom(var2.map((var1x) -> {
         return var1x.apply(var64);
      }), var0);
      ...
      ModelLayers.ZOMBIE_VILLAGER_BABY_ARMOR.putFrom(var65.map((var0x) -> {
         return var0x.apply(HumanoidModel.BABY_TRANSFORMER);
      }), var0);
      ...
      List var71 = ModelLayers.getKnownLocations().filter((var1x) -> {
         return !var70.containsKey(var1x);
      }).toList();
      if (!var71.isEmpty()) {
