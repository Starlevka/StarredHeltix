   ...
   public void tick() {
      ...
      if (!this.level.getBlockState(BlockPos.containing(this.x, this.y, this.z)).isAir()) {
         ...
         if (Math.random() > 0.95D || this.age == 1) {
            this.setParticleSpeed(-0.05000000074505806D + 0.10000000149011612D * Math.random(), -0.05000000074505806D + 0.10000000149011612D * Math.random(), -0.05000000074505806D + 0.10000000149011612D * Math.random());
         }
