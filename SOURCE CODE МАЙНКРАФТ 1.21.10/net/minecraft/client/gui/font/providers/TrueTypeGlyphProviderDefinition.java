...
public record TrueTypeGlyphProviderDefinition(ResourceLocation location, float size, float oversample, TrueTypeGlyphProviderDefinition.Shift shift, String skip) implements GlyphProviderDefinition {
   ...
   public TrueTypeGlyphProviderDefinition(ResourceLocation param1, float param2, float param3, TrueTypeGlyphProviderDefinition.Shift param4, String param5) {
      super();
      this.location = var1;
      this.size = var2;
   ...
   public static record Shift(float x, float y) {
      ...
      public static final Codec<TrueTypeGlyphProviderDefinition.Shift> CODEC = Codec.floatRange(-512.0F, 512.0F).listOf().comapFlatMap((var0) -> {
      ...
      public Shift(float param1, float param2) {
         super();
         this.x = var1;
         this.y = var2;
      }
