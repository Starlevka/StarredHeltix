...
public class PlayerGlyphProvider {
         ...
         public GlyphSource load(FontDescription.PlayerSprite var1) {
            ...
            return new SingleSpriteSource(new BakedGlyph(this) {
               ...
               public TextRenderable createGlyph(float var1, float var2x, int var3x, int var4, Style var5, float var6, float var7) {
                  return new PlayerGlyphProvider.Instance(var2, var3, var1, var2x, var3x, var4, var7);
               }
            });
         }
   ...
   private static record Instance(Supplier<PlayerSkinRenderCache.RenderInfo> skin, boolean hat, float x, float y, int color, int shadowColor, float shadowOffset) implements PlainTextRenderable {
      Instance(Supplier<PlayerSkinRenderCache.RenderInfo> param1, boolean param2, float param3, float param4, int param5, int param6, float param7) {
         super();
         this.skin = var1;
         this.hat = var2;
         this.x = var3;
