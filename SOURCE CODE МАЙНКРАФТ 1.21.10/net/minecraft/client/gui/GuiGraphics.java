...
public class GuiGraphics {
   ...
   private final List<GuiGraphics.OutlineBox> deferredOutlines;
   ...
   public void submitOutline(int var1, int var2, int var3, int var4, int var5) {
      this.deferredOutlines.add(new GuiGraphics.OutlineBox(var1, var2, var3, var4, var5));
   }
   ...
   public void setTooltipForNextFrame(Font var1, Component var2, int var3, int var4) {
      this.setTooltipForNextFrame(var1, (Component)var2, var3, var4, (ResourceLocation)null);
   }
   ...
   public void renderDeferredElements() {
      if (!this.deferredOutlines.isEmpty()) {
         this.nextStratum();
         Iterator var1 = this.deferredOutlines.iterator();

         while(var1.hasNext()) {
            GuiGraphics.OutlineBox var2 = (GuiGraphics.OutlineBox)var1.next();
            var2.render(this);
         }
   ...
   static record OutlineBox(int x, int y, int width, int height, int color) {
      OutlineBox(int param1, int param2, int param3, int param4, int param5) {
         super();
         this.x = var1;
         this.y = var2;
         this.width = var3;
