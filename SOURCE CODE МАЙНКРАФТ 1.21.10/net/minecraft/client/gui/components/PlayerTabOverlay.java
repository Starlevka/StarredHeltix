   ...
   public void render(GuiGraphics var1, int var2, Scoreboard var3, @Nullable Objective var4) {
      ...
      for(int var44 = 0; var44 < var33; ++var44) {
         ...
         if (var44 < var5.size()) {
            ...
            PlayerTabOverlay.ScoreDisplayEntry var28 = (PlayerTabOverlay.ScoreDisplayEntry)var6.get(var44);
            ...
            if (var4 != null && var27.getGameMode() != GameType.SPECTATOR) {
               ...
               if (var48 - var47 > 5) {
                  this.renderTablistScore(var4, var26, var28, var47, var48, var29.id(), var1);
               }
            }
   ...
   private void renderTablistHearts(int var1, int var2, int var3, UUID var4, GuiGraphics var5, int var6) {
      ...
      if (var8 > 0) {
         ...
         if (var11 <= 3) {
            ...
            var5.drawString(this.minecraft.font, (Component)var16, (var3 + var2 - this.minecraft.font.width((FormattedText)var16)) / 2, var1, ARGB.opaque(var13));
         } else {
            ...
            for(var13 = 0; var13 < var8; ++var13) {
               ...
               if (var10) {
                  if (var13 * 2 + 1 < var7.displayedValue()) {
                     var5.blitSprite(RenderPipelines.GUI_TEXTURED, (ResourceLocation)HEART_FULL_BLINKING_SPRITE, var2 + var13 * var11, var1, 9, 9);
                  }

                  if (var13 * 2 + 1 == var7.displayedValue()) {
                     var5.blitSprite(RenderPipelines.GUI_TEXTURED, (ResourceLocation)HEART_HALF_BLINKING_SPRITE, var2 + var13 * var11, var1, 9, 9);
                  }
               }

               if (var13 * 2 + 1 < var6) {
                  var5.blitSprite(RenderPipelines.GUI_TEXTURED, (ResourceLocation)(var13 >= 10 ? HEART_ABSORBING_FULL_BLINKING_SPRITE : HEART_FULL_SPRITE), var2 + var13 * var11, var1, 9, 9);
               }

               if (var13 * 2 + 1 == var6) {
                  var5.blitSprite(RenderPipelines.GUI_TEXTURED, (ResourceLocation)(var13 >= 10 ? HEART_ABSORBING_HALF_BLINKING_SPRITE : HEART_HALF_SPRITE), var2 + var13 * var11, var1, 9, 9);
               }
            }
