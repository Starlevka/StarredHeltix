...
public class ChatComponent {
   ...
   private int forEachLine(int var1, int var2, boolean var3, int var4, ChatComponent.LineConsumer var5) {
   ...
   public void render(GuiGraphics var1, int var2, int var3, int var4, boolean var5) {
      if (!this.isChatHidden()) {
         ...
         if (var7 > 0) {
            ...
            int var18 = (int)Math.round(-8.0D * (var16 + 1.0D) + 4.0D * var16);
            ...
            int var23;
            if (var20 > 0L) {
               var22 = (int)(128.0F * var14);
               var23 = (int)(255.0F * var15);
               var1.pose().pushMatrix();
