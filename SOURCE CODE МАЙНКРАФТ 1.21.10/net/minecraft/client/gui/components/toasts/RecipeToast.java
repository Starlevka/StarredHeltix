...
public class RecipeToast implements Toast {
   ...
   public void update(ToastManager var1, long var2) {
      ...
      if (this.recipeItems.isEmpty()) {
         ...
         this.wantedVisibility = (double)(var2 - this.lastChanged) >= 5000.0D * var1.getNotificationDisplayTimeMultiplier() ? Toast.Visibility.HIDE : Toast.Visibility.SHOW;
      }

      this.displayedRecipeIndex = (int)((double)var2 / Math.max(1.0D, 5000.0D * var1.getNotificationDisplayTimeMultiplier() / (double)this.recipeItems.size()) % (double)this.recipeItems.size());
   }
   ...
   public void render(GuiGraphics var1, Font var2, long var3) {
      ...
      RecipeToast.Entry var5 = (RecipeToast.Entry)this.recipeItems.get(this.displayedRecipeIndex);
   ...
   static record Entry(ItemStack categoryItem, ItemStack unlockedItem) {
      Entry(ItemStack param1, ItemStack param2) {
         super();
