...
public interface LayoutSettings {
   ...
   public static class LayoutSettingsImpl implements LayoutSettings {
      ...
      // $FF: synthetic method
      public LayoutSettings alignVertically(final float param1) {
         return this.alignVertically(var1);
      }

      // $FF: synthetic method
      public LayoutSettings alignHorizontally(final float param1) {
         return this.alignHorizontally(var1);
      }

      // $FF: synthetic method
      public LayoutSettings align(final float param1, final float param2) {
         return this.align(var1, var2);
      }

      // $FF: synthetic method
      public LayoutSettings paddingVertical(final int param1) {
         return this.paddingVertical(var1);
      }

      // $FF: synthetic method
      public LayoutSettings paddingHorizontal(final int param1) {
         return this.paddingHorizontal(var1);
      }

      // $FF: synthetic method
      public LayoutSettings paddingBottom(final int param1) {
         return this.paddingBottom(var1);
      }

      // $FF: synthetic method
      public LayoutSettings paddingRight(final int param1) {
         return this.paddingRight(var1);
      }

      // $FF: synthetic method
      public LayoutSettings paddingTop(final int param1) {
         return this.paddingTop(var1);
      }

      // $FF: synthetic method
      public LayoutSettings paddingLeft(final int param1) {
         return this.paddingLeft(var1);
      }

      // $FF: synthetic method
      public LayoutSettings padding(final int param1, final int param2, final int param3, final int param4) {
         return this.padding(var1, var2, var3, var4);
      }

      // $FF: synthetic method
      public LayoutSettings padding(final int param1, final int param2) {
         return this.padding(var1, var2);
      }

      // $FF: synthetic method
      public LayoutSettings padding(final int param1) {
