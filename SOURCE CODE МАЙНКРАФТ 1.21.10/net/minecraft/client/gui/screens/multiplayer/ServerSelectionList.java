   ...
   public class OnlineServerEntry extends ServerSelectionList.Entry {
      ...
      public void renderContent(GuiGraphics var1, int var2, int var3, boolean var4, float var5) {
         ...
         if (this.statusIcon != null) {
            var1.blitSprite(RenderPipelines.GUI_TEXTURED, (ResourceLocation)this.statusIcon, var8, this.getContentY(), 10, 8);
         }
      ...
      public boolean mouseClicked(MouseButtonEvent var1, boolean var2) {
         ...
         if (var3 <= 32.0D) {
            if (var3 < 32.0D && var3 > 16.0D && this.canJoin()) {
               this.join();
               return true;
            }

            int var7 = this.screen.serverSelectionList.children().indexOf(this);
            if (var3 < 16.0D && var5 < 16.0D && var7 > 0) {
               this.swap(var7, var7 - 1);
               return true;
            }

            if (var3 < 16.0D && var5 > 16.0D && var7 < this.screen.getServers().size() - 1) {
               this.swap(var7, var7 + 1);
               return true;
            }
         }
