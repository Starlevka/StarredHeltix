...
public abstract class WarningScreen extends Screen {
   ...
   protected void init() {
      ...
      this.messageWidget = (FittingMultiLineTextWidget)var1.addChild(new FittingMultiLineTextWidget(0, 0, this.width - 100, this.height - 100, this.message, this.font), (Consumer)((var0) -> {
         var0.padding(12);
      }));
