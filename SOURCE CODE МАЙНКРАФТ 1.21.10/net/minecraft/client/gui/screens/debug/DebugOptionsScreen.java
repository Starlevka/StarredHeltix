...
public class DebugOptionsScreen extends Screen {
   ...
   class OptionList extends ContainerObjectSelectionList<DebugOptionsScreen.AbstractOptionEntry> {
      private static final Comparator<Entry<ResourceLocation, DebugScreenEntry>> COMPARATOR = (var0, var1) -> {
   ...
   class OptionEntry extends DebugOptionsScreen.AbstractOptionEntry {
      ...
      public OptionEntry(final ResourceLocation param2) {
         super();
         this.location = var2;
         ...
         this.always = CycleButton.booleanBuilder(DebugOptionsScreen.ENABLED_TEXT.copy().withColor(-2142128), DebugOptionsScreen.ENABLED_TEXT.copy().withColor(-4539718)).displayOnlyValue().withCustomNarration(this::narrateButton).create(10, 5, 44, 16, Component.literal(var4), (var2x, var3x) -> {
            this.setValue(var2, DebugScreenEntryStatus.ALWAYS_ON);
         });
         this.f3 = CycleButton.booleanBuilder(DebugOptionsScreen.IN_F3_TEXT.copy().withColor(-171), DebugOptionsScreen.IN_F3_TEXT.copy().withColor(-4539718)).displayOnlyValue().withCustomNarration(this::narrateButton).create(10, 5, 44, 16, Component.literal(var4), (var2x, var3x) -> {
            this.setValue(var2, DebugScreenEntryStatus.IN_F3);
         });
         this.never = CycleButton.booleanBuilder(DebugOptionsScreen.DISABLED_TEXT.copy().withColor(-1), DebugOptionsScreen.DISABLED_TEXT.copy().withColor(-4539718)).displayOnlyValue().withCustomNarration(this::narrateButton).create(10, 5, 44, 16, Component.literal(var4), (var2x, var3x) -> {
