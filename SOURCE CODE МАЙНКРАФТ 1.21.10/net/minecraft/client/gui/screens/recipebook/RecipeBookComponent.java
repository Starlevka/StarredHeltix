      ...
      if (this.isVisible() && !this.minecraft.player.isSpectator()) {
         if (this.recipeBookPage.mouseClicked(var1, this.getXOrigin(), this.getYOrigin(), 147, 166, var2)) {
            ...
            if (this.searchBox != null) {
               var3 = this.magnifierIconPlacement != null && this.magnifierIconPlacement.containsPoint(Mth.floor(var1.x()), Mth.floor(var1.y()));
            ...
            if (this.filterButton.mouseClicked(var1, var2)) {
               var3 = this.toggleFiltering();
               this.filterButton.setStateTriggered(var3);
               this.updateFilterButtonTooltip();
               this.sendUpdateSettings();
               this.updateCollections(false, var3);
               return true;
            } else {
