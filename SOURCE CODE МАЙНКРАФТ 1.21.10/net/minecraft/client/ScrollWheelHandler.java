...
public class ScrollWheelHandler {
   ...
   public Vector2i onMouseScroll(double var1, double var3) {
      if (this.accumulatedScrollX != 0.0D && Math.signum(var1) != Math.signum(this.accumulatedScrollX)) {
         this.accumulatedScrollX = 0.0D;
      }

      if (this.accumulatedScrollY != 0.0D && Math.signum(var3) != Math.signum(this.accumulatedScrollY)) {
