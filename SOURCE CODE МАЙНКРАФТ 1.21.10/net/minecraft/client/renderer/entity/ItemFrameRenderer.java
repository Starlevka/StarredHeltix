...
public class ItemFrameRenderer<T extends ItemFrame> extends EntityRenderer<T, ItemFrameRenderState> {
   ...
   public void submit(ItemFrameRenderState var1, PoseStack var2, SubmitNodeCollector var3, CameraRenderState var4) {
      ...
      var2.translate((double)var5.getStepX() * 0.46875D, (double)var5.getStepY() * 0.46875D, (double)var5.getStepZ() * 0.46875D);
      float var9;
      float var10;
      ...
      if (var1.mapId != null) {
         ...
         var14 = this.getLightCoords(var1.isGlowFrame, 15728880, var1.lightCoords);
   ...
   public Vec3 getRenderOffset(ItemFrameRenderState var1) {
      return new Vec3((double)((float)var1.direction.getStepX() * 0.3F), -0.25D, (double)((float)var1.direction.getStepZ() * 0.3F));
   }
   ...
   // $FF: synthetic method
   protected Component getNameTag(final Entity param1) {
