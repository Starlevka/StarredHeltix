...
public class PandaRenderer extends AgeableMobRenderer<Panda, PandaRenderState, PandaModel> {
   ...
   protected void setupRotations(PandaRenderState var1, PoseStack var2, float var3, float var4) {
      ...
      if (var5 > 0.0F) {
         ...
         var2.mulPose((Quaternionfc)Axis.XP.rotationDegrees(Mth.lerp(var5, var1.xRot, var1.xRot + 90.0F)));
         var2.translate(0.0F, -1.0F * var5, 0.0F);
         if (var1.isScared) {
            var14 = (float)(Math.cos((double)(var1.ageInTicks * 1.25F)) * 3.141592653589793D * 0.05000000074505806D);
            var2.mulPose((Quaternionfc)Axis.YP.rotationDegrees(var14));
            if (var1.isBaby) {
      ...
      if (var14 > 0.0F) {
         ...
         var2.mulPose((Quaternionfc)Axis.XP.rotationDegrees(Mth.lerp(var14, var1.xRot, var1.xRot + 180.0F)));
      }
