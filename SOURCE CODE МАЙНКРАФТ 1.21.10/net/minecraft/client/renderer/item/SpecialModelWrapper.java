...
public class SpecialModelWrapper<T> implements ItemModel {
   ...
   public static record Unbaked(ResourceLocation base, SpecialModelRenderer.Unbaked specialModel) implements ItemModel.Unbaked {
      public static final MapCodec<SpecialModelWrapper.Unbaked> MAP_CODEC = RecordCodecBuilder.mapCodec((var0) -> {
         return var0.group(ResourceLocation.CODEC.fieldOf("base").forGetter(SpecialModelWrapper.Unbaked::base), SpecialModelRenderers.CODEC.fieldOf("model").forGetter(SpecialModelWrapper.Unbaked::specialModel)).apply(var0, SpecialModelWrapper.Unbaked::new);
      });

      public Unbaked(ResourceLocation param1, SpecialModelRenderer.Unbaked param2) {
         super();
         this.base = var1;
