...
public class ModelBlockRenderer {
   ...
   private static void calculateShape(BlockAndTintGetter var0, BlockState var1, BlockPos var2, int[] var3, Direction var4, ModelBlockRenderer.CommonRenderStorage var5) {
      float var6 = 32.0F;
      float var7 = 32.0F;
      float var8 = 32.0F;
      float var9 = -32.0F;
      ...
      for(int var12 = 0; var12 < 4; ++var12) {
         var13 = Float.intBitsToFloat(var3[var12 * 8]);
      ...
      if (var5 instanceof ModelBlockRenderer.AmbientOcclusionRenderStorage) {
         ModelBlockRenderer.AmbientOcclusionRenderStorage var16 = (ModelBlockRenderer.AmbientOcclusionRenderStorage)var5;
      ...
      case UP:
         ...
         break;
      case NORTH:
         var10001 = var8 == var11 && (var8 < 1.0E-4F || var1.isCollisionShapeFullBlock(var0, var2));
         break;
      case SOUTH:
         var10001 = var8 == var11 && (var11 > 0.9999F || var1.isCollisionShapeFullBlock(var0, var2));
         break;
      case WEST:
