...
public record Unstitcher(ResourceLocation resource, List<Unstitcher.Region> regions, double xDivisor, double yDivisor) implements SpriteSource {
   ...
   public static record Region(ResourceLocation sprite, double x, double y, double width, double height) {
      ...
      public Region(ResourceLocation param1, double param2, double param4, double param6, double param8) {
         super();
         this.sprite = var1;
         this.x = var2;
         this.y = var4;
