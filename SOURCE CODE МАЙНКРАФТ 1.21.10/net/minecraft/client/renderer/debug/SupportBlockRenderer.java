...
public class SupportBlockRenderer implements DebugRenderer.SimpleDebugRenderer {
   ...
   public void render(PoseStack var1, MultiBufferSource var2, double var3, double var5, double var7, DebugValueAccess var9, Frustum var10) {
      ...
      if (var11 - this.lastUpdateTime > 1.0E8D) {
         ...
         this.surroundEntities = ImmutableList.copyOf(var13.level().getEntities(var13, var13.getBoundingBox().inflate(16.0D)));
      }

      LocalPlayer var16 = this.minecraft.player;
      if (var16 != null && var16.mainSupportingBlockPos.isPresent()) {
         this.drawHighlights(var1, var2, var3, var5, var7, var16, () -> {
            return 0.0D;
         }, 1.0F, 0.0F, 0.0F);
      }

      Iterator var14 = this.surroundEntities.iterator();

      while(var14.hasNext()) {
         Entity var15 = (Entity)var14.next();
         if (var15 != var16) {
            this.drawHighlights(var1, var2, var3, var5, var7, var15, () -> {
               return this.getBias(var15);
            }, 0.0F, 1.0F, 0.0F);
         }
      }
