...
public class OctreeDebugRenderer implements DebugRenderer.SimpleDebugRenderer {
   ...
   public void render(PoseStack var1, MultiBufferSource var2, double var3, double var5, double var7, DebugValueAccess var9, Frustum var10) {
      ...
      var11.visitNodes((var10x, var11x, var12x, var13) -> {
         this.renderNode(var10x, var1, var2, var3, var5, var7, var12x, var11x, var12, var13);
      }, var10, 32);
   }
   ...
   private void renderNode(Octree.Node var1, PoseStack var2, MultiBufferSource var3, double var4, double var6, double var8, int var10, boolean var11, MutableInt var12, boolean var13) {
      ...
      long var17 = Math.round(var15 / 16.0D);
      if (var17 == 1L) {
         var12.add(1);
      ...
      long var20 = var17 + 5L;
      ShapeRenderer.renderLineBox(var2.last(), var26, var14.deflate(0.1D * (double)var10).move(-var4, -var6, -var8), getColorComponent(var20, 0.3F), getColorComponent(var20, 0.8F), getColorComponent(var20, 0.5F), var11 ? 0.4F : 1.0F);
   }
