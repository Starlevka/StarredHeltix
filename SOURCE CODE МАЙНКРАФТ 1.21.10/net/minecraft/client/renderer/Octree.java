...
public class Octree {
   ...
   class Branch implements Octree.Node {
      ...
      public Branch(final BoundingBox param2) {
         super();
      ...
      public boolean add(SectionRenderDispatcher.RenderSection var1) {
         ...
         if (this.areChildrenLeaves()) {
            ...
            Octree.Branch var13 = (Octree.Branch)this.nodes[var10];
            return var13.add(var1);
         } else {
            BoundingBox var11 = this.createChildBoundingBox(var4, var5, var6);
            Octree.Branch var12 = Octree.this.new Branch(var11);
      ...
      public void visitNodes(Octree.OctreeVisitor var1, boolean var2, Frustum var3, int var4, int var5, boolean var6) {
         ...
         if (var7) {
            ...
            Octree.Node[] var12 = this.nodes;
            int var9 = var12.length;

            for(int var10 = 0; var10 < var9; ++var10) {
               Octree.Node var11 = var12[var10];
               if (var11 != null) {
   ...
   private static enum AxisSorting {
      ...
      private AxisSorting(final int param3, final int param4, final int param5) {
         this.xShift = var3;
         this.yShift = var4;
         this.zShift = var5;
      }
      ...
      // $FF: synthetic method
      private static Octree.AxisSorting[] $values() {
         return new Octree.AxisSorting[]{XYZ, XZY, YXZ, YZX, ZXY, ZYX};
      }
   }
   ...
   private final class Leaf implements Octree.Node {
      ...
      Leaf(final SectionRenderDispatcher.RenderSection param2) {
         super();
         this.section = var2;
      }
