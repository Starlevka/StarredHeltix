...
public class TreePlacements {
   ...
   public static void bootstrap(BootstrapContext<PlacedFeature> var0) {
      ...
      PlacementUtils.register(var0, PINE_ON_SNOW, var13, (List)var42);
      PlacementUtils.register(var0, SPRUCE_ON_SNOW, var10, (List)var42);
      ...
      PlacementUtils.register(var0, OAK_BEES_0002_LEAF_LITTER, var23, (PlacementModifier[])(PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING)));
      ...
      PlacementUtils.register(var0, BIRCH_BEES_0002_LEAF_LITTER, var26, (PlacementModifier[])(PlacementUtils.filteredByBlockSurvival(Blocks.BIRCH_SAPLING)));
      PlacementUtils.register(var0, BIRCH_BEES_002, var27, (PlacementModifier[])(PlacementUtils.filteredByBlockSurvival(Blocks.BIRCH_SAPLING)));
      PlacementUtils.register(var0, FANCY_OAK_BEES_0002_LEAF_LITTER, var28, (PlacementModifier[])(PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING)));
      PlacementUtils.register(var0, FANCY_OAK_BEES_002, var29, (PlacementModifier[])(PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING)));
      PlacementUtils.register(var0, FANCY_OAK_BEES, var30, (PlacementModifier[])(PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING)));
      PlacementUtils.register(var0, CHERRY_BEES_005, var31, (PlacementModifier[])(PlacementUtils.filteredByBlockSurvival(Blocks.CHERRY_SAPLING)));
      PlacementUtils.register(var0, OAK_LEAF_LITTER, var32, (PlacementModifier[])(PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING)));
      PlacementUtils.register(var0, DARK_OAK_LEAF_LITTER, var33, (PlacementModifier[])(PlacementUtils.filteredByBlockSurvival(Blocks.DARK_OAK_SAPLING)));
      PlacementUtils.register(var0, BIRCH_LEAF_LITTER, var34, (PlacementModifier[])(PlacementUtils.filteredByBlockSurvival(Blocks.BIRCH_SAPLING)));
      PlacementUtils.register(var0, FANCY_OAK_LEAF_LITTER, var35, (PlacementModifier[])(PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING)));
      PlacementUtils.register(var0, FALLEN_OAK_TREE, var36, (PlacementModifier[])(PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING)));
      PlacementUtils.register(var0, FALLEN_BIRCH_TREE, var37, (PlacementModifier[])(PlacementUtils.filteredByBlockSurvival(Blocks.BIRCH_SAPLING)));
      PlacementUtils.register(var0, FALLEN_SUPER_BIRCH_TREE, var38, (PlacementModifier[])(PlacementUtils.filteredByBlockSurvival(Blocks.BIRCH_SAPLING)));
      PlacementUtils.register(var0, FALLEN_SPRUCE_TREE, var39, (PlacementModifier[])(PlacementUtils.filteredByBlockSurvival(Blocks.SPRUCE_SAPLING)));
      PlacementUtils.register(var0, FALLEN_JUNGLE_TREE, var40, (PlacementModifier[])(PlacementUtils.filteredByBlockSurvival(Blocks.JUNGLE_SAPLING)));
   }
}
