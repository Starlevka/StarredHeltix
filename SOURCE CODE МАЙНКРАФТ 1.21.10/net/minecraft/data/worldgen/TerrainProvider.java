...
public class TerrainProvider {
   ...
   static {
      ...
      AMPLIFIED_OFFSET = BoundedFloatFunction.createUnlimited((var0) -> {
         return var0 < 0.0F ? var0 : var0 * 2.0F;
      });
      AMPLIFIED_FACTOR = BoundedFloatFunction.createUnlimited((var0) -> {
         return 1.25F - 6.25F / (var0 + 5.0F);
      });
      AMPLIFIED_JAGGEDNESS = BoundedFloatFunction.createUnlimited((var0) -> {
         return var0 * 2.0F;
      });
   }
}
