...
public class TransmuteRecipeBuilder implements RecipeBuilder {
   ...
   public void save(RecipeOutput var1, ResourceKey<Recipe<?>> var2) {
      ...
      TransmuteRecipe var4 = new TransmuteRecipe((String)Objects.requireNonNullElse(this.group, ""), RecipeBuilder.determineBookCategory(this.category), this.input, this.material, new TransmuteResult((Item)this.result.value()));
