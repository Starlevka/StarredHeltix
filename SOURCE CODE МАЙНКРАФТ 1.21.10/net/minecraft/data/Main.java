...
public class Main {
   ...
   public static void addServerProviders(DataGenerator var0, Collection<Path> var1, boolean var2, boolean var3, boolean var4) {
      ...
      TagsProvider var7 = (TagsProvider)var11.addProvider(bindRegistries(VanillaItemTagsProvider::new, var15));
      ...
      var11.addProvider(bindRegistries(DialogTagsProvider::new, var15));
