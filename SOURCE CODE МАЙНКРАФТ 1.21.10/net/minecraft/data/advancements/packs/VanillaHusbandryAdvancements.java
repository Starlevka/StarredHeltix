...
public class VanillaHusbandryAdvancements implements AdvancementSubProvider {
   ...
   public void generate(HolderLookup.Provider var1, Consumer<AdvancementHolder> var2) {
      ...
      AdvancementHolder var23 = Advancement.Builder.advancement().parent(var22).display((ItemLike)Items.TORCHFLOWER_SEEDS, Component.translatable("advancements.husbandry.feed_snifflet.title"), Component.translatable("advancements.husbandry.feed_snifflet.description"), (ResourceLocation)null, AdvancementType.TASK, true, true, true).addCriterion("feed_snifflet", PlayerInteractTrigger.TriggerInstance.itemUsedOnEntity(ItemPredicate.Builder.item().of(var4, (TagKey)ItemTags.SNIFFER_FOOD), Optional.of(EntityPredicate.wrap(EntityPredicate.Builder.entity().of(var3, (EntityType)EntityType.SNIFFER).flags(EntityFlagsPredicate.Builder.flags().setIsBaby(true)))))).save(var2, "husbandry/feed_snifflet");
      ...
      Advancement.Builder.advancement().parent(var13).display((ItemLike)Items.SHEARS, Component.translatable("advancements.husbandry.remove_wolf_armor.title"), Component.translatable("advancements.husbandry.remove_wolf_armor.description"), (ResourceLocation)null, AdvancementType.TASK, true, true, false).addCriterion("remove_wolf_armor", PlayerInteractTrigger.TriggerInstance.equipmentSheared(ItemPredicate.Builder.item().of(var4, (ItemLike[])(Items.WOLF_ARMOR)), Optional.of(EntityPredicate.wrap(EntityPredicate.Builder.entity().of(var3, (EntityType)EntityType.WOLF))))).save(var2, "husbandry/remove_wolf_armor");
      Advancement.Builder.advancement().parent(var13).display((ItemLike)Items.WOLF_ARMOR, Component.translatable("advancements.husbandry.repair_wolf_armor.title"), Component.translatable("advancements.husbandry.repair_wolf_armor.description"), (ResourceLocation)null, AdvancementType.TASK, true, true, false).addCriterion("repair_wolf_armor", PlayerInteractTrigger.TriggerInstance.itemUsedOnEntity(ItemPredicate.Builder.item().of(var4, (ItemLike[])(Items.ARMADILLO_SCUTE)), Optional.of(EntityPredicate.wrap(EntityPredicate.Builder.entity().of(var3, (EntityType)EntityType.WOLF).equipment(EntityEquipmentPredicate.Builder.equipment().body(ItemPredicate.Builder.item().of(var4, (ItemLike[])(Items.WOLF_ARMOR)).withComponents(DataComponentMatchers.Builder.components().exact(DataComponentExactPredicate.expect(DataComponents.DAMAGE, 0)).build()))))))).save(var2, "husbandry/repair_wolf_armor");
   ...
   private static Advancement.Builder addLeashedFrogVariants(HolderGetter<EntityType<?>> var0, HolderGetter<Item> var1, HolderLookup<FrogVariant> var2, Advancement.Builder var3) {
      sortedVariants(var2).forEach((var3x) -> {
         var3.addCriterion(var3x.key().location().toString(), PlayerInteractTrigger.TriggerInstance.itemUsedOnEntity(ItemPredicate.Builder.item().of(var1, Items.LEAD), Optional.of(EntityPredicate.wrap(EntityPredicate.Builder.entity().of(var0, EntityType.FROG).components(DataComponentMatchers.Builder.components().exact(DataComponentExactPredicate.expect(DataComponents.FROG_VARIANT, var3x)).build())))));
      });
      return var3;
   }
   ...
   private static Advancement.Builder addCatVariants(Advancement.Builder var0, HolderLookup<CatVariant> var1) {
      sortedVariants(var1).forEach((var1x) -> {
         var0.addCriterion(var1x.key().location().toString(), TameAnimalTrigger.TriggerInstance.tamedAnimal(EntityPredicate.Builder.entity().components(DataComponentMatchers.Builder.components().exact(DataComponentExactPredicate.expect(DataComponents.CAT_VARIANT, var1x)).build())));
      });
      return var0;
   }
   ...
   private static Advancement.Builder addTamedWolfVariants(Advancement.Builder var0, HolderLookup<WolfVariant> var1) {
      sortedVariants(var1).forEach((var1x) -> {
         var0.addCriterion(var1x.key().location().toString(), TameAnimalTrigger.TriggerInstance.tamedAnimal(EntityPredicate.Builder.entity().components(DataComponentMatchers.Builder.components().exact(DataComponentExactPredicate.expect(DataComponents.WOLF_VARIANT, var1x)).build())));
      });
      return var0;
   }
