...
public class VanillaBlockLoot extends BlockLootSubProvider {
   ...
   protected void generate() {
      ...
      Blocks.COPPER_BARS.forEach((var1x) -> {
         this.dropSelf(var1x);
      });
      ...
      Blocks.COPPER_CHAIN.forEach((var1x) -> {
         this.dropSelf(var1x);
      });
      ...
      this.add(Blocks.COPPER_GOLEM_STATUE, (var1x) -> {
         return this.createCopperGolemStatueBlock(var1x);
      });
      this.add(Blocks.EXPOSED_COPPER_GOLEM_STATUE, (var1x) -> {
         return this.createCopperGolemStatueBlock(var1x);
      });
      this.add(Blocks.WEATHERED_COPPER_GOLEM_STATUE, (var1x) -> {
         return this.createCopperGolemStatueBlock(var1x);
      });
      this.add(Blocks.OXIDIZED_COPPER_GOLEM_STATUE, (var1x) -> {
         return this.createCopperGolemStatueBlock(var1x);
      });
      this.add(Blocks.WAXED_COPPER_GOLEM_STATUE, (var1x) -> {
         return this.createCopperGolemStatueBlock(var1x);
      });
      this.add(Blocks.WAXED_EXPOSED_COPPER_GOLEM_STATUE, (var1x) -> {
         return this.createCopperGolemStatueBlock(var1x);
      });
      this.add(Blocks.WAXED_WEATHERED_COPPER_GOLEM_STATUE, (var1x) -> {
         return this.createCopperGolemStatueBlock(var1x);
      });
      this.add(Blocks.WAXED_OXIDIZED_COPPER_GOLEM_STATUE, (var1x) -> {
         return this.createCopperGolemStatueBlock(var1x);
      });
      ...
      this.add(Blocks.RESIN_BRICK_SLAB, (var1x) -> {
         return this.createSlabItemTable(var1x);
      });
      ...
      this.add(Blocks.COPPER_CHEST, (var1x) -> {
         return this.createNameableBlockEntityTable(var1x);
      });
      this.add(Blocks.EXPOSED_COPPER_CHEST, (var1x) -> {
         return this.createNameableBlockEntityTable(var1x);
      });
      this.add(Blocks.WEATHERED_COPPER_CHEST, (var1x) -> {
         return this.createNameableBlockEntityTable(var1x);
      });
      this.add(Blocks.OXIDIZED_COPPER_CHEST, (var1x) -> {
         return this.createNameableBlockEntityTable(var1x);
      });
      this.add(Blocks.WAXED_COPPER_CHEST, (var1x) -> {
         return this.createNameableBlockEntityTable(var1x);
      });
      this.add(Blocks.WAXED_EXPOSED_COPPER_CHEST, (var1x) -> {
         return this.createNameableBlockEntityTable(var1x);
      });
      this.add(Blocks.WAXED_WEATHERED_COPPER_CHEST, (var1x) -> {
         return this.createNameableBlockEntityTable(var1x);
      });
      this.add(Blocks.WAXED_OXIDIZED_COPPER_CHEST, (var1x) -> {
         return this.createNameableBlockEntityTable(var1x);
      });
      ...
      Blocks.COPPER_LANTERN.forEach((var1x) -> {
         this.add(var1x, this::createSingleItemTable);
      });
      ...
      this.add(Blocks.PLAYER_HEAD, (var1x) -> {
         return LootTable.lootTable().withPool((LootPool.Builder)this.applyExplosionCondition(var1x, LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F)).add(LootItem.lootTableItem(var1x).apply(CopyComponentsFunction.copyComponentsFromBlockEntity(LootContextParams.BLOCK_ENTITY).include(DataComponents.PROFILE).include(DataComponents.NOTE_BLOCK_SOUND).include(DataComponents.CUSTOM_NAME)))));
      });
      ...
      this.add(Blocks.SHORT_DRY_GRASS, (var1x) -> {
         return this.createShearsOrSilkTouchOnlyDrop(var1x);
      });
      this.add(Blocks.TALL_DRY_GRASS, (var1x) -> {
         return this.createShearsOrSilkTouchOnlyDrop(var1x);
      });
      this.add(Blocks.BUSH, (var1x) -> {
         return this.createShearsOrSilkTouchOnlyDrop(var1x);
      });
