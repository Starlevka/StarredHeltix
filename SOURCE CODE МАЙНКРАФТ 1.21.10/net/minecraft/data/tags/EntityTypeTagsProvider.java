...
public class EntityTypeTagsProvider extends IntrinsicHolderTagsProvider<EntityType<?>> {
   ...
   protected void addTags(HolderLookup.Provider var1) {
      ...
      this.tag(EntityTypeTags.CAN_EQUIP_SADDLE).add((Object[])(EntityType.HORSE, EntityType.SKELETON_HORSE, EntityType.ZOMBIE_HORSE, EntityType.DONKEY, EntityType.MULE, EntityType.PIG, EntityType.STRIDER, EntityType.CAMEL));
      this.tag(EntityTypeTags.CAN_EQUIP_HARNESS).add((Object)EntityType.HAPPY_GHAST);
      this.tag(EntityTypeTags.CAN_WEAR_HORSE_ARMOR).add((Object)EntityType.HORSE);
      ...
      this.tag(EntityTypeTags.CANNOT_BE_PUSHED_ONTO_BOATS).add((Object)EntityType.PLAYER).add((Object)EntityType.ELDER_GUARDIAN).add((Object)EntityType.COD).add((Object)EntityType.PUFFERFISH).add((Object)EntityType.SALMON).add((Object)EntityType.TROPICAL_FISH).add((Object)EntityType.DOLPHIN).add((Object)EntityType.SQUID).add((Object)EntityType.GLOW_SQUID).add((Object)EntityType.TADPOLE).add((Object)EntityType.CREAKING);
