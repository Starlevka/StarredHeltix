...
public class BlockPos extends Vec3i {
   ...
   public static int breadthFirstTraversal(BlockPos var0, int var1, int var2, BiConsumer<BlockPos, Consumer<BlockPos>> var3, Function<BlockPos, BlockPos.TraversalNodeStatus> var4) {
      ...
      while(!var5.isEmpty()) {
         ...
         if (var6.add(var11)) {
            BlockPos.TraversalNodeStatus var13 = (BlockPos.TraversalNodeStatus)var4.apply(var9);
   ...
   public static Iterable<BlockPos> betweenCornersInDirection(int var0, int var1, int var2, int var3, int var4, int var5, Vec3 var6) {
      ...
      int var16 = var6.x >= 0.0D ? var7 : var10;
      int var17 = var6.y >= 0.0D ? var8 : var11;
      int var18 = var6.z >= 0.0D ? var9 : var12;
      ...
      Direction var23 = var6.get(var20) >= 0.0D ? var20.getPositive() : var20.getNegative();
      Direction var24 = var6.get(var21) >= 0.0D ? var21.getPositive() : var21.getNegative();
      Direction var25 = var6.get(var22) >= 0.0D ? var22.getPositive() : var22.getNegative();
      ...
      return () -> {
         return new AbstractIterator<BlockPos>() {
            ...
            private boolean end;
            private final int firstDirX = var0.getStepX();
            private final int firstDirY = var0.getStepY();
            private final int firstDirZ = var0.getStepZ();
            private final int secondDirX = var1.getStepX();
            private final int secondDirY = var1.getStepY();
            private final int secondDirZ = var1.getStepZ();
            private final int thirdDirX = var2.getStepX();
            private final int thirdDirY = var2.getStepY();
            private final int thirdDirZ = var2.getStepZ();

            protected BlockPos computeNext() {
               if (this.end) {
                  return (BlockPos)this.endOfData();
               } else {
                  this.cursor.set(var3 + this.firstDirX * this.firstIndex + this.secondDirX * this.secondIndex + this.thirdDirX * this.thirdIndex, var4 + this.firstDirY * this.firstIndex + this.secondDirY * this.secondIndex + this.thirdDirY * this.thirdIndex, var5 + this.firstDirZ * this.firstIndex + this.secondDirZ * this.secondIndex + this.thirdDirZ * this.thirdIndex);
                  if (this.thirdIndex < var6) {
                     ++this.thirdIndex;
                  } else if (this.secondIndex < var7) {
                     ++this.secondIndex;
                     this.thirdIndex = 0;
                  } else if (this.firstIndex < var8) {
                     ++this.firstIndex;
                     this.thirdIndex = 0;
                     this.secondIndex = 0;
                  } else {
   ...
   public static enum TraversalNodeStatus {
      ...
      // $FF: synthetic method
      private static BlockPos.TraversalNodeStatus[] $values() {
         return new BlockPos.TraversalNodeStatus[]{ACCEPT, SKIP, STOP};
      }
   }
}
