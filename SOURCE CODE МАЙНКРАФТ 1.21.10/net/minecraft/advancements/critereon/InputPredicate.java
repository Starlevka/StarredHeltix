...
public record InputPredicate(Optional<Boolean> forward, Optional<Boolean> backward, Optional<Boolean> left, Optional<Boolean> right, Optional<Boolean> jump, Optional<Boolean> sneak, Optional<Boolean> sprint) {
   ...
   public InputPredicate(Optional<Boolean> param1, Optional<Boolean> param2, Optional<Boolean> param3, Optional<Boolean> param4, Optional<Boolean> param5, Optional<Boolean> param6, Optional<Boolean> param7) {
      super();
      this.forward = var1;
      this.backward = var2;
      this.left = var3;
