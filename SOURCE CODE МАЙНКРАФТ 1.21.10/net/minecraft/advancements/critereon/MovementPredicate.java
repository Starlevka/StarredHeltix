...
public record MovementPredicate(MinMaxBounds.Doubles x, MinMaxBounds.Doubles y, MinMaxBounds.Doubles z, MinMaxBounds.Doubles speed, MinMaxBounds.Doubles horizontalSpeed, MinMaxBounds.Doubles verticalSpeed, MinMaxBounds.Doubles fallDistance) {
   ...
   public MovementPredicate(MinMaxBounds.Doubles param1, MinMaxBounds.Doubles param2, MinMaxBounds.Doubles param3, MinMaxBounds.Doubles param4, MinMaxBounds.Doubles param5, MinMaxBounds.Doubles param6, MinMaxBounds.Doubles param7) {
      super();
      this.x = var1;
      this.y = var2;
      this.z = var3;
