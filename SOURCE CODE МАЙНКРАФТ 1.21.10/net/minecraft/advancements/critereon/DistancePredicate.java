...
public record DistancePredicate(MinMaxBounds.Doubles x, MinMaxBounds.Doubles y, MinMaxBounds.Doubles z, MinMaxBounds.Doubles horizontal, MinMaxBounds.Doubles absolute) {
   ...
   public DistancePredicate(MinMaxBounds.Doubles param1, MinMaxBounds.Doubles param2, MinMaxBounds.Doubles param3, MinMaxBounds.Doubles param4, MinMaxBounds.Doubles param5) {
      super();
      this.x = var1;
      this.y = var2;
      this.z = var3;
