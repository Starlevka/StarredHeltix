...
public interface CollectionContentsPredicate<T, P extends Predicate<T>> extends Predicate<Iterable<T>> {
   ...
   static <T, P extends Predicate<T>> CollectionContentsPredicate<T, P> of(List<P> var0) {
      ...
      switch(var0.size()) {
      case 0:
         var10000 = new CollectionContentsPredicate.Zero();
         break;
      case 1:
         var10000 = new CollectionContentsPredicate.Single((Predicate)var0.getFirst());
         break;
      default:
         var10000 = new CollectionContentsPredicate.Multiple(var0);
      }
