...
class LinkFSPath implements Path {
   ...
   // $FF: synthetic method
   public Path toRealPath(final LinkOption[] param1) throws IOException {
   ...
   // $FF: synthetic method
   public Path relativize(final Path param1) {
      return this.relativize(var1);
   }

   // $FF: synthetic method
   public Path resolve(final Path param1) {
   ...
   // $FF: synthetic method
   public Path subpath(final int param1, final int param2) {
      return this.subpath(var1, var2);
   }

   // $FF: synthetic method
   public Path getName(final int param1) {
