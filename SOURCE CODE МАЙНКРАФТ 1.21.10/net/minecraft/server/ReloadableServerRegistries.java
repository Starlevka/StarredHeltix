...
public class ReloadableServerRegistries {
   ...
   public static CompletableFuture<ReloadableServerRegistries.LoadResult> reload(LayeredRegistryAccess<RegistryLayer> var0, List<Registry.PendingTags<?>> var1, ResourceManager var2, Executor var3) {
   ...
   private static ReloadableServerRegistries.LoadResult createAndValidateFullContext(LayeredRegistryAccess<RegistryLayer> var0, HolderLookup.Provider var1, List<WritableRegistry<?>> var2) {
   ...
   private static void validateLootRegistries(HolderLookup.Provider var0) {
      ...
      var1.forEach((var0x, var1x) -> {
         LOGGER.warn("Found loot table element validation problem in {}: {}", var0x, var1x.description());
      });
   }
   ...
   public static record LoadResult(LayeredRegistryAccess<RegistryLayer> layers, HolderLookup.Provider lookupWithUpdatedTags) {
      public LoadResult(LayeredRegistryAccess<RegistryLayer> param1, HolderLookup.Provider param2) {
         super();
         this.layers = var1;
