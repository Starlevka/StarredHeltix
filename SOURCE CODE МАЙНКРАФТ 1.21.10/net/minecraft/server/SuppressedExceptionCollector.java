...
public class SuppressedExceptionCollector {
   ...
   public synchronized void addEntry(String var1, Throwable var2) {
      ...
      this.latestEntries.add(new SuppressedExceptionCollector.LongEntry(var3, var1, var2.getClass(), var5));

      while(this.latestEntries.size() > 8) {
         this.latestEntries.remove();
      }

      SuppressedExceptionCollector.ShortEntry var6 = new SuppressedExceptionCollector.ShortEntry(var1, var2.getClass());
   ...
   public synchronized String dump() {
      ...
      if (!this.latestEntries.isEmpty()) {
         ...
         while(var4.hasNext()) {
            SuppressedExceptionCollector.LongEntry var5 = (SuppressedExceptionCollector.LongEntry)var4.next();
      ...
      if (!this.entryCounts.isEmpty()) {
         ...
         while(var6.hasNext()) {
            ...
            var3.append("\t\t\t").append(((SuppressedExceptionCollector.ShortEntry)var7.getKey()).location).append(":").append(((SuppressedExceptionCollector.ShortEntry)var7.getKey()).cls).append(" x ").append(var7.getIntValue()).append("\n");
         }
      }
   ...
   private static record LongEntry(long timestampMs, String location, Class<? extends Throwable> cls, String message) {
      ...
      LongEntry(long param1, String param3, Class<? extends Throwable> param4, String param5) {
         super();
   ...
   static record ShortEntry(String location, Class<? extends Throwable> cls) {
      ...
      ShortEntry(String param1, Class<? extends Throwable> param2) {
         super();
         this.location = var1;
         this.cls = var2;
      }
