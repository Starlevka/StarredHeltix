...
public class TeamCommand {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> var0, CommandBuildContext var1) {
      var0.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("team").requires(Commands.hasPermission(2))).then(((LiteralArgumentBuilder)Commands.literal("list").executes((var0x) -> {
         ...
         return createTeam((CommandSourceStack)var0x.getSource(), StringArgumentType.getString(var0x, "team"), ComponentArgument.getResolvedComponent(var0x, "displayName"));
         ...
         return setDisplayName((CommandSourceStack)var0x.getSource(), TeamArgument.getTeam(var0x, "team"), ComponentArgument.getResolvedComponent(var0x, "displayName"));
         ...
         return setPrefix((CommandSourceStack)var0x.getSource(), TeamArgument.getTeam(var0x, "team"), ComponentArgument.getResolvedComponent(var0x, "prefix"));
      })))).then(Commands.literal("suffix").then(Commands.argument("suffix", ComponentArgument.textComponent(var1)).executes((var0x) -> {
         return setSuffix((CommandSourceStack)var0x.getSource(), TeamArgument.getTeam(var0x, "team"), ComponentArgument.getResolvedComponent(var0x, "suffix"));
      }))))));
   }
