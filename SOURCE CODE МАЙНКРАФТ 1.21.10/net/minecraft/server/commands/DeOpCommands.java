...
public class DeOpCommands {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> var0) {
      var0.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("deop").requires(Commands.hasPermission(3))).then(Commands.argument("targets", GameProfileArgument.gameProfile()).suggests((var0x, var1) -> {
   ...
   private static int deopPlayers(CommandSourceStack var0, Collection<NameAndId> var1) throws CommandSyntaxException {
      ...
      while(var4.hasNext()) {
         ...
         if (var2.isOp(var5)) {
            ...
            ++var3;
            var0.sendSuccess(() -> {
               return Component.translatable("commands.deop.success", ((NameAndId)var1.iterator().next()).name());
            }, true);
         }
      }
