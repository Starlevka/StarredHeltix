...
public class SpreadPlayersCommand {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> var0) {
      var0.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("spreadplayers").requires(Commands.hasPermission(2))).then(Commands.argument("center", Vec2Argument.vec2()).then(Commands.argument("spreadDistance", FloatArgumentType.floatArg(0.0F)).then(((RequiredArgumentBuilder)Commands.argument("maxRange", FloatArgumentType.floatArg(1.0F)).then(Commands.argument("respectTeams", BoolArgumentType.bool()).then(Commands.argument("targets", EntityArgument.entities()).executes((var0x) -> {
   ...
   private static double setPlayerPositions(Collection<? extends Entity> var0, ServerLevel var1, SpreadPlayersCommand.Position[] var2, int var3, boolean var4) {
      ...
      for(Iterator var9 = var0.iterator(); var9.hasNext(); var5 += var20) {
         ...
         var10.teleportTo(var1, (double)Mth.floor(var11.x) + 0.5D, (double)var11.getSpawnY(var1, var3), (double)Mth.floor(var11.z) + 0.5D, Set.of(), var10.getYRot(), var10.getXRot(), true);
