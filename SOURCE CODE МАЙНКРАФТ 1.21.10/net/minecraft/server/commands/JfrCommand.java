...
public class JfrCommand {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> var0) {
      var0.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("jfr").requires(Commands.hasPermission(4))).then(Commands.literal("start").executes((var0x) -> {
   ...
   private static int stopJfr(CommandSourceStack var0) throws CommandSyntaxException {
      try {
         ...
         MutableComponent var3 = Component.literal(var1.toString()).withStyle(ChatFormatting.UNDERLINE).withStyle((var1x) -> {
            return var1x.withClickEvent(new ClickEvent.CopyToClipboard(var2.toString())).withHoverEvent(new HoverEvent.ShowText(Component.translatable("chat.copy.click")));
         });
         var0.sendSuccess(() -> {
