...
public class TitleCommand {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> var0, CommandBuildContext var1) {
      var0.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("title").requires(Commands.hasPermission(2))).then(((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)Commands.argument("targets", EntityArgument.players()).then(Commands.literal("clear").executes((var0x) -> {
         ...
         return showTitle((CommandSourceStack)var0x.getSource(), EntityArgument.getPlayers(var0x, "targets"), ComponentArgument.getRawComponent(var0x, "title"), "title", ClientboundSetTitleTextPacket::new);
      })))).then(Commands.literal("subtitle").then(Commands.argument("title", ComponentArgument.textComponent(var1)).executes((var0x) -> {
         return showTitle((CommandSourceStack)var0x.getSource(), EntityArgument.getPlayers(var0x, "targets"), ComponentArgument.getRawComponent(var0x, "title"), "subtitle", ClientboundSetSubtitleTextPacket::new);
      })))).then(Commands.literal("actionbar").then(Commands.argument("title", ComponentArgument.textComponent(var1)).executes((var0x) -> {
         return showTitle((CommandSourceStack)var0x.getSource(), EntityArgument.getPlayers(var0x, "targets"), ComponentArgument.getRawComponent(var0x, "title"), "actionbar", ClientboundSetActionBarTextPacket::new);
