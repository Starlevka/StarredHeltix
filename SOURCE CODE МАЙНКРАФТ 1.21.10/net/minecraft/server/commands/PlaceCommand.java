...
public class PlaceCommand {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> var0) {
      var0.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("place").requires(Commands.hasPermission(2))).then(Commands.literal("feature").then(((RequiredArgumentBuilder)Commands.argument("feature", ResourceKeyArgument.key(Registries.CONFIGURED_FEATURE)).executes((var0x) -> {
         ...
         return placeTemplate((CommandSourceStack)var0x.getSource(), ResourceLocationArgument.getId(var0x, "template"), BlockPos.containing(((CommandSourceStack)var0x.getSource()).getPosition()), Rotation.NONE, Mirror.NONE, 1.0F, 0, false);
      })).then(((RequiredArgumentBuilder)Commands.argument("pos", BlockPosArgument.blockPos()).executes((var0x) -> {
         return placeTemplate((CommandSourceStack)var0x.getSource(), ResourceLocationArgument.getId(var0x, "template"), BlockPosArgument.getLoadedBlockPos(var0x, "pos"), Rotation.NONE, Mirror.NONE, 1.0F, 0, false);
      })).then(((RequiredArgumentBuilder)Commands.argument("rotation", TemplateRotationArgument.templateRotation()).executes((var0x) -> {
         return placeTemplate((CommandSourceStack)var0x.getSource(), ResourceLocationArgument.getId(var0x, "template"), BlockPosArgument.getLoadedBlockPos(var0x, "pos"), TemplateRotationArgument.getRotation(var0x, "rotation"), Mirror.NONE, 1.0F, 0, false);
      })).then(((RequiredArgumentBuilder)Commands.argument("mirror", TemplateMirrorArgument.templateMirror()).executes((var0x) -> {
         return placeTemplate((CommandSourceStack)var0x.getSource(), ResourceLocationArgument.getId(var0x, "template"), BlockPosArgument.getLoadedBlockPos(var0x, "pos"), TemplateRotationArgument.getRotation(var0x, "rotation"), TemplateMirrorArgument.getMirror(var0x, "mirror"), 1.0F, 0, false);
      })).then(((RequiredArgumentBuilder)Commands.argument("integrity", FloatArgumentType.floatArg(0.0F, 1.0F)).executes((var0x) -> {
         return placeTemplate((CommandSourceStack)var0x.getSource(), ResourceLocationArgument.getId(var0x, "template"), BlockPosArgument.getLoadedBlockPos(var0x, "pos"), TemplateRotationArgument.getRotation(var0x, "rotation"), TemplateMirrorArgument.getMirror(var0x, "mirror"), FloatArgumentType.getFloat(var0x, "integrity"), 0, false);
      })).then(((RequiredArgumentBuilder)Commands.argument("seed", IntegerArgumentType.integer()).executes((var0x) -> {
         return placeTemplate((CommandSourceStack)var0x.getSource(), ResourceLocationArgument.getId(var0x, "template"), BlockPosArgument.getLoadedBlockPos(var0x, "pos"), TemplateRotationArgument.getRotation(var0x, "rotation"), TemplateMirrorArgument.getMirror(var0x, "mirror"), FloatArgumentType.getFloat(var0x, "integrity"), IntegerArgumentType.getInteger(var0x, "seed"), false);
