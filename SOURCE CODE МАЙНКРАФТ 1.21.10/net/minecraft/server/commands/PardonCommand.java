...
public class PardonCommand {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> var0) {
      var0.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("pardon").requires(Commands.hasPermission(3))).then(Commands.argument("targets", GameProfileArgument.gameProfile()).suggests((var0x, var1) -> {
   ...
   private static int pardonPlayers(CommandSourceStack var0, Collection<NameAndId> var1) throws CommandSyntaxException {
      ...
      while(var4.hasNext()) {
         ...
         if (var2.isBanned(var5)) {
            ...
            ++var3;
            var0.sendSuccess(() -> {
               return Component.translatable("commands.pardon.success", Component.literal(var5.name()));
            }, true);
         }
      }
