...
public class BanIpCommands {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> var0) {
      var0.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("ban-ip").requires(Commands.hasPermission(3))).then(((RequiredArgumentBuilder)Commands.argument("target", StringArgumentType.word()).executes((var0x) -> {
   ...
   private static int banIp(CommandSourceStack var0, String var1, @Nullable Component var2) throws CommandSyntaxException {
      ...
      if (var3.isBanned(var1)) {
         ...
         var3.add(var5);
         var0.sendSuccess(() -> {
            return Component.translatable("commands.banip.success", var1, var5.getReasonMessage());
         }, true);
         if (!var4.isEmpty()) {
            var0.sendSuccess(() -> {
