...
public class PlayerSafetyServiceTextFilter extends ServerTextFilter {
   ...
   public static ServerTextFilter createTextFilterFromConfig(String var0) {
      ...
      try {
         var29 = ((Builder)((Builder)ConfidentialClientApplication.builder(var6, var20).sendX5c(true).executorService(var19)).authority(String.format(Locale.ROOT, "https://login.microsoftonline.com/%s/", var7))).build();
