...
public abstract class ServerTextFilter implements AutoCloseable {
   ...
   private JsonObject processRequestResponse(JsonObject var1, URL var2) throws IOException {
      ...
      label90: {
         try {
            ...
            try {
               var5 = LenientJsonParser.parse((Reader)(new InputStreamReader(var4, StandardCharsets.UTF_8))).getAsJsonObject();
            } finally {
   ...
   public interface IgnoreStrategy {
      ServerTextFilter.IgnoreStrategy NEVER_IGNORE = (var0, var1) -> {
         return false;
      };
      ServerTextFilter.IgnoreStrategy IGNORE_FULLY_FILTERED = (var0, var1) -> {
      ...
      static ServerTextFilter.IgnoreStrategy select(int var0) {
         ServerTextFilter.IgnoreStrategy var10000;
         switch(var0) {
         case -1:
