...
public enum ChatFormatting implements StringRepresentable {
   ...
   public static final Codec<ChatFormatting> COLOR_CODEC = CODEC.validate((var0) -> {
      return var0.isFormat() ? DataResult.error(() -> {
         return "Formatting was not a valid color: " + String.valueOf(var0);
