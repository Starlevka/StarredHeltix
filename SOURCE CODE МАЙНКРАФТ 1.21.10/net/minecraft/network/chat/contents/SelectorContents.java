...
public record SelectorContents(SelectorPattern selector, Optional<Component> separator) implements ComponentContents {
   public static final MapCodec<SelectorContents> MAP_CODEC = RecordCodecBuilder.mapCodec((var0) -> {
   ...
   public SelectorContents(SelectorPattern param1, Optional<Component> param2) {
      super();
      this.selector = var1;
      this.separator = var2;
   }
