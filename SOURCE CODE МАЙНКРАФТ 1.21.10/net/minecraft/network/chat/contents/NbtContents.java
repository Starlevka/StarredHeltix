...
public class NbtContents implements ComponentContents {
   ...
   public static final MapCodec<NbtContents> MAP_CODEC = RecordCodecBuilder.mapCodec((var0) -> {
      ...
      if (var1 != null && this.compiledNbtPath != null) {
         ...
         if (this.interpreting) {
            ...
            return (MutableComponent)var4.flatMap((var4x) -> {
               ...
               return var1x.append(var6).append((Component)var2x);
            ...
            return (MutableComponent)ComponentUtils.updateForEntity(var1, this.separator, var2, var3).map((var1x) -> {
               return (MutableComponent)var5.map(Component::literal).reduce((var1, var2) -> {
                  return var1.append((Component)var1x).append((Component)var2);
               }).orElseGet(Component::empty);
            }).orElseGet(() -> {
               return Component.literal((String)var5.collect(Collectors.joining(", ")));
            });
         }
      } else {
