...
public record SignedMessageBody(String content, Instant timeStamp, long salt, LastSeenMessages lastSeen) {
   ...
   public SignedMessageBody(String param1, Instant param2, long param3, LastSeenMessages param5) {
      super();
      this.content = var1;
      this.timeStamp = var2;
      this.salt = var3;
   ...
   public static record Packed(String content, Instant timeStamp, long salt, LastSeenMessages.Packed lastSeen) {
      ...
      public Packed(String param1, Instant param2, long param3, LastSeenMessages.Packed param5) {
         super();
         this.content = var1;
         this.timeStamp = var2;
         this.salt = var3;
