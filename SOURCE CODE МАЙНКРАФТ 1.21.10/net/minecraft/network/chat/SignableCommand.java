...
public record SignableCommand<S>(List<SignableCommand.Argument<S>> arguments) {
   public SignableCommand(List<SignableCommand.Argument<S>> param1) {
      super();
      this.arguments = var1;
   }
   ...
   public SignableCommand.Argument<S> getArgument(String var1) {
      ...
      SignableCommand.Argument var3;
      do {
         if (!var2.hasNext()) {
            return null;
         }

         var3 = (SignableCommand.Argument)var2.next();
   ...
   public static record Argument<S>(ArgumentCommandNode<S, ?> node, String value) {
      public Argument(ArgumentCommandNode<S, ?> param1, String param2) {
         super();
         this.node = var1;
         this.value = var2;
      }
