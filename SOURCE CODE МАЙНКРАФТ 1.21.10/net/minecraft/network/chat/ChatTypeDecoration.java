...
public record ChatTypeDecoration(String translationKey, List<ChatTypeDecoration.Parameter> parameters, Style style) {
   ...
   public ChatTypeDecoration(String param1, List<ChatTypeDecoration.Parameter> param2, Style param3) {
      super();
   ...
   public static enum Parameter implements StringRepresentable {
      ...
      private static final IntFunction<ChatTypeDecoration.Parameter> BY_ID = ByIdMap.continuous((var0) -> {
         return var0.id;
      ...
      public static final StreamCodec<ByteBuf, ChatTypeDecoration.Parameter> STREAM_CODEC = ByteBufCodecs.idMapper(BY_ID, (var0) -> {
         return var0.id;
      });
