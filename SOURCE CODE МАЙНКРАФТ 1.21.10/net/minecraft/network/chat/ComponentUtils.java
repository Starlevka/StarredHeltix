...
public class ComponentUtils {
   ...
   private static Style resolveStyle(@Nullable CommandSourceStack var0, Style var1, @Nullable Entity var2, int var3) throws CommandSyntaxException {
      ...
      if (var4 instanceof HoverEvent.ShowText) {
         HoverEvent.ShowText var5 = (HoverEvent.ShowText)var4;
         ...
         Component var7 = var9;
         HoverEvent.ShowText var10 = new HoverEvent.ShowText(updateForEntity(var0, var7, var2, var3 + 1));
         return var1.withHoverEvent(var10);
      } else {
         return var1;
      }
   }
   ...
   public static MutableComponent copyOnClickText(String var0) {
      return wrapInSquareBrackets(Component.literal(var0).withStyle((var1) -> {
         return var1.withColor(ChatFormatting.GREEN).withClickEvent(new ClickEvent.CopyToClipboard(var0)).withHoverEvent(new HoverEvent.ShowText(Component.translatable("chat.copy.click"))).withInsertion(var0);
      }));
   }
