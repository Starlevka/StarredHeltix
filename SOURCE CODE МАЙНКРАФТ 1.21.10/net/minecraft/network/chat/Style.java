...
public final class Style {
   ...
   public static class Serializer {
      public static final MapCodec<Style> MAP_CODEC = RecordCodecBuilder.mapCodec((var0) -> {
         ...
         }), ClickEvent.CODEC.optionalFieldOf("click_event").forGetter((var0x) -> {
            return Optional.ofNullable(var0x.clickEvent);
         }), HoverEvent.CODEC.optionalFieldOf("hover_event").forGetter((var0x) -> {
         ...
         }), FontDescription.CODEC.optionalFieldOf("font").forGetter((var0x) -> {
