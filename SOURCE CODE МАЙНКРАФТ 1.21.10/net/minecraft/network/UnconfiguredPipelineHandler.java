...
public class UnconfiguredPipelineHandler {
   ...
   public static class Outbound extends ChannelOutboundHandlerAdapter {
      ...
      public void write(ChannelHandlerContext var1, Object var2, ChannelPromise var3) throws Exception {
         if (var2 instanceof Packet) {
            ...
            if (var2 instanceof UnconfiguredPipelineHandler.OutboundConfigurationTask) {
               UnconfiguredPipelineHandler.OutboundConfigurationTask var4 = (UnconfiguredPipelineHandler.OutboundConfigurationTask)var2;
   ...
   public static class Inbound extends ChannelDuplexHandler {
      ...
      public void write(ChannelHandlerContext var1, Object var2, ChannelPromise var3) throws Exception {
         if (var2 instanceof UnconfiguredPipelineHandler.InboundConfigurationTask) {
            UnconfiguredPipelineHandler.InboundConfigurationTask var4 = (UnconfiguredPipelineHandler.InboundConfigurationTask)var2;
