...
public interface CustomPacketPayload {
   ...
   static <B extends FriendlyByteBuf> StreamCodec<B, CustomPacketPayload> codec(final CustomPacketPayload.FallbackProvider<B> var0, List<CustomPacketPayload.TypeAndCodec<? super B, ?>> var1) {
   ...
   public static record Type<T extends CustomPacketPayload>(ResourceLocation id) {
      ...
      public Type(ResourceLocation param1) {
         super();
         this.id = var1;
      }
   ...
   public static record TypeAndCodec<B extends FriendlyByteBuf, T extends CustomPacketPayload>(CustomPacketPayload.Type<T> type, StreamCodec<B, T> codec) {
      public TypeAndCodec(CustomPacketPayload.Type<T> param1, StreamCodec<B, T> param2) {
         super();
         this.type = var1;
         this.codec = var2;
      }
