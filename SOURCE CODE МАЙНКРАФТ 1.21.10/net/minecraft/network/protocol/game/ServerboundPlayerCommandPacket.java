...
public class ServerboundPlayerCommandPacket implements Packet<ServerGamePacketListener> {
   ...
   public static enum Action {
      ...
      private static ServerboundPlayerCommandPacket.Action[] $values() {
         return new ServerboundPlayerCommandPacket.Action[]{STOP_SLEEPING, START_SPRINTING, STOP_SPRINTING, START_RIDING_JUMP, STOP_RIDING_JUMP, OPEN_INVENTORY, START_FALL_FLYING};
      }
   }
}
