...
public record ClientboundRecipeBookAddPacket(List<ClientboundRecipeBookAddPacket.Entry> entries, boolean replace) implements Packet<ClientGamePacketListener> {
   ...
   public ClientboundRecipeBookAddPacket(List<ClientboundRecipeBookAddPacket.Entry> param1, boolean param2) {
      super();
      this.entries = var1;
      this.replace = var2;
   }
   ...
   public List<ClientboundRecipeBookAddPacket.Entry> entries() {
      return this.entries;
   }
   ...
   public static record Entry(RecipeDisplayEntry contents, byte flags) {
      ...
      public Entry(RecipeDisplayEntry param1, byte param2) {
         super();
         this.contents = var1;
         this.flags = var2;
      }
      ...
      static {
         STREAM_CODEC = StreamCodec.composite(RecipeDisplayEntry.STREAM_CODEC, ClientboundRecipeBookAddPacket.Entry::contents, ByteBufCodecs.BYTE, ClientboundRecipeBookAddPacket.Entry::flags, ClientboundRecipeBookAddPacket.Entry::new);
      }
   }
}
