...
public class ClientboundCommandsPacket implements Packet<ClientGamePacketListener> {
   ...
   private static <S> ClientboundCommandsPacket.Entry createEntry(CommandNode<S> var0, ClientboundCommandsPacket.NodeInspector<S> var1, Object2IntMap<CommandNode<S>> var2) {
      ...
      case 1:
         ...
         ResourceLocation var11 = var1.suggestionId(var9);
   ...
   static record ArgumentNodeStub(String id, ArgumentTypeInfo.Template<?> argumentType, @Nullable ResourceLocation suggestionId) implements ClientboundCommandsPacket.NodeStub {
      ArgumentNodeStub(String param1, ArgumentTypeInfo.Template<?> param2, @Nullable ResourceLocation param3) {
         super();
         this.id = var1;
