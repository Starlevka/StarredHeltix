...
public class SynchedEntityData {
   ...
   public List<SynchedEntityData.DataValue<?>> packDirty() {
      if (!this.isDirty) {
         ...
         SynchedEntityData.DataItem[] var2 = this.itemsById;
         int var3 = var2.length;

         for(int var4 = 0; var4 < var3; ++var4) {
            SynchedEntityData.DataItem var5 = var2[var4];
            if (var5.isDirty()) {
               var5.setDirty(false);
               var1.add(var5.value());
            }
   ...
   public static record DataValue<T>(int id, EntityDataSerializer<T> serializer, T value) {
      ...
      public DataValue(int param1, EntityDataSerializer<T> param2, T param3) {
         super();
         this.id = var1;
      ...
      public static <T> SynchedEntityData.DataValue<T> create(EntityDataAccessor<T> var0, T var1) {
         ...
         return new SynchedEntityData.DataValue(var0.id(), var2, var2.copy(var1));
      }
      ...
      private static <T> SynchedEntityData.DataValue<T> read(RegistryFriendlyByteBuf var0, int var1, EntityDataSerializer<T> var2) {
         return new SynchedEntityData.DataValue(var1, var2, var2.codec().decode(var0));
      }
