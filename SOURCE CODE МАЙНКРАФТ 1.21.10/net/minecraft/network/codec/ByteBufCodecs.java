...
public interface ByteBufCodecs {
   ...
   StreamCodec<ByteBuf, PropertyMap> GAME_PROFILE_PROPERTIES = new StreamCodec<ByteBuf, PropertyMap>() {
      ...
      public PropertyMap decode(ByteBuf var1) {
         ...
         Builder var3 = ImmutableMultimap.builder();
      ...
      return (var2) -> {
         return new StreamCodec<B, V>() {
            public V decode(B var1x) {
               ...
               return var0.parse(var1, var2x).getOrThrow((var1xx) -> {
                  return new DecoderException("Failed to decode: " + var1xx + " " + String.valueOf(var2x));
               });
            }

            public void encode(B var1x, V var2x) {
               Object var3 = var0.encodeStart(var1, var2x).getOrThrow((var1xx) -> {
                  return new EncoderException("Failed to encode: " + var1xx + " " + String.valueOf(var2x));
               });
   ...
   static <T> StreamCodec<ByteBuf, T> fromCodec(Codec<T> var0, Supplier<NbtAccounter> var1) {
      return tagCodec(var1).apply(fromCodec((DynamicOps)NbtOps.INSTANCE, (Codec)var0));
   }
   ...
   static <V> StreamCodec.CodecOperation<ByteBuf, V, V> lengthPrefixed(int var0) {
      return lengthPrefixed(var0, (var0x, var1) -> {
         return var1;
      });
   }
   ...
   static <V> StreamCodec.CodecOperation<RegistryFriendlyByteBuf, V, V> registryFriendlyLengthPrefixed(int var0) {
      return lengthPrefixed(var0, (var0x, var1) -> {
         return new RegistryFriendlyByteBuf(var1, var0x.registryAccess());
      });
   }
