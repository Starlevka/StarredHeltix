...
public class SpawnUtil {
   ...
   public static <T extends Mob> Optional<T> trySpawnMob(EntityType<T> var0, EntitySpawnReason var1, ServerLevel var2, BlockPos var3, int var4, int var5, int var6, SpawnUtil.Strategy var7, boolean var8) {
      ...
      for(int var10 = 0; var10 < var4; ++var10) {
         ...
         if (var2.getWorldBorder().isWithinBounds((BlockPos)var9) && moveToPossibleSpawnPosition(var2, var6, var9, var7) && (!var8 || var2.noCollision(var0.getSpawnAABB((double)var9.getX() + 0.5D, (double)var9.getY(), (double)var9.getZ() + 0.5D)))) {
   ...
   public interface Strategy {
      ...
      SpawnUtil.Strategy ON_TOP_OF_COLLIDER_NO_LEAVES = (var0, var1, var2, var3, var4) -> {
