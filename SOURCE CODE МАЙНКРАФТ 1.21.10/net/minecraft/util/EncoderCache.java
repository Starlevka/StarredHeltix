...
public class EncoderCache {
   ...
   public EncoderCache(int var1) {
      super();
      this.cache = CacheBuilder.newBuilder().maximumSize((long)var1).concurrencyLevel(1).softValues().build(new CacheLoader<EncoderCache.Key<?, ?>, DataResult<?>>(this) {
         ...
         public Object load(final Object param1) throws Exception {
            return this.load((EncoderCache.Key)var1);
         }
      });
   }
   ...
   public <A> Codec<A> wrap(final Codec<A> var1) {
      return new Codec<A>() {
         ...
         public <T> DataResult<T> encode(A var1x, DynamicOps<T> var2, T var3) {
            return ((DataResult)EncoderCache.this.cache.getUnchecked(new EncoderCache.Key(var1, var1x, var2))).map((var0) -> {
               if (var0 instanceof Tag) {
                  Tag var1x = (Tag)var0;
                  return var1x.copy();
               } else {
                  return var0;
   ...
   private static record Key<A, T>(Codec<A> codec, A value, DynamicOps<T> ops) {
      Key(Codec<A> param1, A param2, DynamicOps<T> param3) {
         super();
         this.codec = var1;
         this.value = var2;
         this.ops = var3;
      ...
      public boolean equals(Object var1) {
         if (this == var1) {
            return true;
         } else if (!(var1 instanceof EncoderCache.Key)) {
            return false;
         } else {
            EncoderCache.Key var2 = (EncoderCache.Key)var1;
