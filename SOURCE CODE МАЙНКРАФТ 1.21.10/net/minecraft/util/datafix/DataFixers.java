   ...
   private static void addFixers(DataFixerBuilder var0) {
      ...
      var0.addFixer(new NamedEntityWriteReadFix(var58, true, "Command block block entity custom name fix", References.BLOCK_ENTITY, "minecraft:command_block") {
         protected <T> Dynamic<T> fix(Dynamic<T> var1) {
            return BlockEntityCustomNameToComponentFix.fixTagCustomName(var1);
         }
      });
      var0.addFixer(new DataFix(var58, false) {
         protected TypeRewriteRule makeRule() {
            ...
            return this.fixTypeEverywhereTyped("Command block minecart custom name fix", var1, (var3x) -> {
               ...
               return !"minecraft:commandblock_minecart".equals(var4x) ? var3x : var3x.updateTyped(var3, (var1) -> {
                  return var1.update(var4, (var0) -> {
      ...
      var0.addFixer(new CriteriaRenameFix(var168, "Migrate cat variant advancement", "minecraft:husbandry/complete_catalogue", (var1x) -> {
         return (String)var169.getOrDefault(var1x, var1x);
      }));
      ...
      var0.addFixer(new EntityAttributeBaseValueFix(var254, "Villager follow range fix undo", "minecraft:villager", "minecraft:follow_range", (var0x) -> {
         return var0x == 48.0D ? 16.0D : var0x;
      }));
      var0.addFixer(new EntityAttributeBaseValueFix(var254, "Bee follow range fix", "minecraft:bee", "minecraft:follow_range", (var0x) -> {
         return var0x == 48.0D ? 16.0D : var0x;
      }));
      var0.addFixer(new EntityAttributeBaseValueFix(var254, "Allay follow range fix", "minecraft:allay", "minecraft:follow_range", (var0x) -> {
         return var0x == 48.0D ? 16.0D : var0x;
      }));
      var0.addFixer(new EntityAttributeBaseValueFix(var254, "Llama follow range fix", "minecraft:llama", "minecraft:follow_range", (var0x) -> {
         return var0x == 40.0D ? 16.0D : var0x;
      }));
      var0.addFixer(new EntityAttributeBaseValueFix(var254, "Piglin Brute follow range fix", "minecraft:piglin_brute", "minecraft:follow_range", (var0x) -> {
         return var0x == 16.0D ? 12.0D : var0x;
      }));
      var0.addFixer(new EntityAttributeBaseValueFix(var254, "Warden follow range fix", "minecraft:warden", "minecraft:follow_range", (var0x) -> {
         return var0x == 16.0D ? 24.0D : var0x;
      }));
      ...
      var0.addFixer(new BlockPropertyRenameAndFix(var259, "CreakingHeartBlockStateFix", "minecraft:creaking_heart", "active", "creaking_heart_state", (var0x) -> {
         return var0x.equals("true") ? "awake" : "uprooted";
      }));
      ...
      var0.addFixer(new BlockPropertyRenameAndFix(var268, "rename test block mode", "minecraft:test_block", "test_block_mode", "mode", (var0x) -> {
         return var0x;
      }));
      ...
      var0.addFixer(new AddFieldFix(var277, References.PLAYER, "style", (var0x) -> {
         return var0x.createString("minecraft:default");
      }, new String[]{"locator_bar_icon"}));
      var0.addFixer(new AddFieldFix(var277, References.ENTITY, "style", (var0x) -> {
         return var0x.createString("minecraft:default");
      }, new String[]{"locator_bar_icon"}));
