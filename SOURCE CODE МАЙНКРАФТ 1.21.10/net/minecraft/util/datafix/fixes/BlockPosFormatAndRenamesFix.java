...
public class BlockPosFormatAndRenamesFix extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      var1.add(this.writeFixAndRead("BlockPos format for map frames", this.getInputSchema().getType(References.SAVED_DATA_MAP_DATA), this.getOutputSchema().getType(References.SAVED_DATA_MAP_DATA), (var1x) -> {
         return var1x.update("data", this::fixMapSavedData);
      }));
      ...
      var1.add(this.fixTypeEverywhereTyped("BlockPos format for compass target", var2, ItemStackTagFix.createFixer(var2, "minecraft:compass"::equals, (var0) -> {
         return var0.update(DSL.remainderFinder(), (var0x) -> {
            return var0x.update("LodestonePos", ExtraDataFixUtils::fixBlockPos);
         });
      })));
