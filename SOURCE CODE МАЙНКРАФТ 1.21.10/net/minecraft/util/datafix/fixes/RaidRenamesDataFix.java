...
public class RaidRenamesDataFix extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("RaidRenamesDataFix", this.getInputSchema().getType(References.SAVED_DATA_RAIDS), (var0) -> {
         return var0.update(DSL.remainderFinder(), (var0x) -> {
            return var0x.update("data", RaidRenamesDataFix::fix);
         });
      });
   }

   private static Dynamic<?> fix(Dynamic<?> var0) {
      return var0.renameAndFixField("Raids", "raids", (var0x) -> {
         return var0x.createList(var0x.asStream().map(RaidRenamesDataFix::fixRaid));
