                     ...
                     case 175:
                        ...
                        while(true) {
                           ...
                           if ("upper".equals(ChunkPalettedStorageFix.getProperty(var12, "half"))) {
                              ...
                              case -1140744476:
                                 if (var22.equals("minecraft:lilac")) {
                                    var16 = 1;
                                 }
                                 break;
                              case -1137166248:
                                 if (var22.equals("minecraft:peony")) {
                                    var16 = 5;
                                 }
                                 break;
                              case -759211604:
                                 if (var22.equals("minecraft:large_fern")) {
                                    var16 = 3;
                                 }
                                 break;
                              case -234588646:
                                 if (var22.equals("minecraft:sunflower")) {
                                    var16 = 0;
                                 }
                                 break;
                              case -192534197:
                                 if (var22.equals("minecraft:rose_bush")) {
                                    var16 = 4;
                                 }
                                 break;
                              case 75238289:
                                 if (var22.equals("minecraft:tall_grass")) {
                                    var16 = 2;
                                 }
                              }
