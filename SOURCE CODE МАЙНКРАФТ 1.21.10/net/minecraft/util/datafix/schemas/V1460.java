...
public class V1460 extends NamespacedSchema {
   ...
   protected static void registerInventory(Schema var0, Map<String, Supplier<TypeTemplate>> var1, String var2) {
      var0.register(var1, var2, () -> {
         return V1458.nameableInventory(var0);
      });
   }
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema var1) {
      ...
      var1.register(var2, "minecraft:commandblock_minecart", (var1x) -> {
         return DSL.optionalFields("DisplayState", References.BLOCK_STATE.in(var1), "LastOutput", References.TEXT_COMPONENT.in(var1));
      });
      registerMob(var1, var2, "minecraft:cow");
      registerMob(var1, var2, "minecraft:creeper");
      var1.register(var2, "minecraft:donkey", (var1x) -> {
         return DSL.optionalFields("Items", DSL.list(References.ITEM_STACK.in(var1)), "SaddleItem", References.ITEM_STACK.in(var1));
      });
      ...
      var1.register(var2, "minecraft:enderman", (var1x) -> {
         return DSL.optionalFields("carriedBlockState", References.BLOCK_STATE.in(var1));
      });
      ...
      var1.register(var2, "minecraft:horse", (var1x) -> {
         return DSL.optionalFields("ArmorItem", References.ITEM_STACK.in(var1), "SaddleItem", References.ITEM_STACK.in(var1));
      });
      ...
      var1.register(var2, "minecraft:llama", (var1x) -> {
         return DSL.optionalFields("Items", DSL.list(References.ITEM_STACK.in(var1)), "SaddleItem", References.ITEM_STACK.in(var1), "DecorItem", References.ITEM_STACK.in(var1));
      });
      ...
      var1.register(var2, "minecraft:skeleton_horse", (var1x) -> {
         return DSL.optionalFields("SaddleItem", References.ITEM_STACK.in(var1));
      });
      ...
      var1.register(var2, "minecraft:zombie_villager", (var1x) -> {
         return DSL.optionalFields("Offers", DSL.optionalFields("Recipes", DSL.list(References.VILLAGER_TRADE.in(var1))));
      });
      return var2;
   }
   ...
   public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema var1) {
      ...
      var1.register(var2, "minecraft:sign", () -> {
         return V99.sign(var1);
      });
      ...
      var1.register(var2, "minecraft:command_block", () -> {
   ...
   public void registerTypes(Schema var1, Map<String, Supplier<TypeTemplate>> var2, Map<String, Supplier<TypeTemplate>> var3) {
      ...
      var1.registerType(true, References.ITEM_STACK, () -> {
         return DSL.hook(DSL.optionalFields("id", References.ITEM_NAME.in(var1), "tag", V99.itemStackTag(var1)), V705.ADD_NAMES, HookFunction.IDENTITY);
      });
      ...
      var1.registerType(false, References.OBJECTIVE, () -> {
         return DSL.hook(DSL.optionalFields("CriteriaType", DSL.taggedChoiceLazy("type", DSL.string(), var5), "DisplayName", References.TEXT_COMPONENT.in(var1)), V1451_6.UNPACK_OBJECTIVE_ID, V1451_6.REPACK_OBJECTIVE_ID);
      });
