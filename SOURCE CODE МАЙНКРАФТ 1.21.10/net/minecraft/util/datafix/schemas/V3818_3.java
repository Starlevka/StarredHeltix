...
public class V3818_3 extends NamespacedSchema {
   ...
   public static SequencedMap<String, Supplier<TypeTemplate>> components(Schema var0) {
      ...
      var1.put("minecraft:custom_name", () -> {
         return References.TEXT_COMPONENT.in(var0);
      });
      var1.put("minecraft:item_name", () -> {
         return References.TEXT_COMPONENT.in(var0);
      });
      var1.put("minecraft:lore", () -> {
         return DSL.list(References.TEXT_COMPONENT.in(var0));
      });
      var1.put("minecraft:written_book_content", () -> {
         return DSL.optionalFields("pages", DSL.list(DSL.or(DSL.optionalFields("raw", References.TEXT_COMPONENT.in(var0), "filtered", References.TEXT_COMPONENT.in(var0)), References.TEXT_COMPONENT.in(var0))));
      });
      return var1;
   }
