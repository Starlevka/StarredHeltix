...
public class V704 extends Schema {
   ...
   public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema var1) {
      ...
      BlockEntityIdFix.ID_MAP.forEach((var1x, var2x) -> {
         var2.put(var2x, (Supplier)Objects.requireNonNull((Supplier)var2.remove(var1x), () -> {
            return "Didn't find " + var1x + " in schema";
         }));
      });
      return var2;
   }
