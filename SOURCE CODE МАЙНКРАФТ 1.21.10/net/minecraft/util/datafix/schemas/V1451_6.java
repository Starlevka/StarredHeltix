...
public class V1451_6 extends NamespacedSchema {
   ...
   public void registerTypes(Schema var1, Map<String, Supplier<TypeTemplate>> var2, Map<String, Supplier<TypeTemplate>> var3) {
      ...
      var1.registerType(false, References.OBJECTIVE, () -> {
         return DSL.hook(DSL.optionalFields("CriteriaType", DSL.taggedChoiceLazy("type", DSL.string(), var5), "DisplayName", References.TEXT_COMPONENT.in(var1)), UNPACK_OBJECTIVE_ID, REPACK_OBJECTIVE_ID);
      });
   }
