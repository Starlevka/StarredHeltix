...
public class ParticleUtils {
   ...
   public static void spawnParticleInBlock(LevelAccessor var0, BlockPos var1, int var2, ParticleOptions var3) {
      ...
      double var7 = var6.isAir() ? 1.0D : var6.getShape(var0, var1).max(Direction.Axis.Y);
      spawnParticles(var0, var1, var2, 0.5D, var7, true, var3);
   }
   ...
   public static void spawnParticles(LevelAccessor var0, BlockPos var1, int var2, double var3, double var5, boolean var7, ParticleOptions var8) {
      ...
      for(int var10 = 0; var10 < var2; ++var10) {
         double var11 = var9.nextGaussian() * 0.02D;
         double var13 = var9.nextGaussian() * 0.02D;
         double var15 = var9.nextGaussian() * 0.02D;
         double var17 = 0.5D - var3;
         double var19 = (double)var1.getX() + var17 + var9.nextDouble() * var3 * 2.0D;
         double var21 = (double)var1.getY() + var9.nextDouble() * var5;
         double var23 = (double)var1.getZ() + var17 + var9.nextDouble() * var3 * 2.0D;
   ...
   public static void spawnSmashAttackParticles(LevelAccessor var0, BlockPos var1, int var2) {
      Vec3 var3 = var1.getCenter().add(0.0D, 0.5D, 0.0D);
      ...
      for(var5 = 0; (float)var5 < (float)var2 / 3.0F; ++var5) {
         var6 = var3.x + var0.getRandom().nextGaussian() / 2.0D;
         var8 = var3.y;
         var10 = var3.z + var0.getRandom().nextGaussian() / 2.0D;
         var12 = var0.getRandom().nextGaussian() * 0.20000000298023224D;
         var14 = var0.getRandom().nextGaussian() * 0.20000000298023224D;
         var16 = var0.getRandom().nextGaussian() * 0.20000000298023224D;
         var0.addParticle(var4, var6, var8, var10, var12, var14, var16);
      }

      for(var5 = 0; (float)var5 < (float)var2 / 1.5F; ++var5) {
         var6 = var3.x + 3.5D * Math.cos((double)var5) + var0.getRandom().nextGaussian() / 2.0D;
         var8 = var3.y;
         var10 = var3.z + 3.5D * Math.sin((double)var5) + var0.getRandom().nextGaussian() / 2.0D;
         var12 = var0.getRandom().nextGaussian() * 0.05000000074505806D;
         var14 = var0.getRandom().nextGaussian() * 0.05000000074505806D;
         var16 = var0.getRandom().nextGaussian() * 0.05000000074505806D;
         var0.addParticle(var4, var6, var8, var10, var12, var14, var16);
      }
