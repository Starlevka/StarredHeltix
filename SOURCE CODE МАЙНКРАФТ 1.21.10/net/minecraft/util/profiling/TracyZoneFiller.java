...
public class TracyZoneFiller implements ProfilerFiller {
   ...
   public void endTick() {
      ...
      while(var1.hasNext()) {
         TracyZoneFiller.PlotAndValue var2 = (TracyZoneFiller.PlotAndValue)var1.next();
         var2.set(0);
      }
   ...
   public void incrementCounter(String var1, int var2) {
      ((TracyZoneFiller.PlotAndValue)this.plots.computeIfAbsent(var1, (var2x) -> {
         return new TracyZoneFiller.PlotAndValue(this.name + " " + var1);
      })).add(var2);
   }
