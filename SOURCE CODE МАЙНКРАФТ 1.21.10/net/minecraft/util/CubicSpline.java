...
public interface CubicSpline<C, I extends BoundedFloatFunction<C>> extends BoundedFloatFunction<C> {
   ...
   static <C, I extends BoundedFloatFunction<C>> CubicSpline.Builder<C, I> builder(I var0) {
      return new CubicSpline.Builder(var0);
   }

   static <C, I extends BoundedFloatFunction<C>> CubicSpline.Builder<C, I> builder(I var0, BoundedFloatFunction<Float> var1) {
   ...
   public static record Multipoint<C, I extends BoundedFloatFunction<C>>(I coordinate, float[] locations, List<CubicSpline<C, I>> values, float[] derivatives, float minValue, float maxValue) implements CubicSpline<C, I> {
      ...
      static <C, I extends BoundedFloatFunction<C>> CubicSpline.Multipoint<C, I> create(I var0, float[] var1, List<CubicSpline<C, I>> var2, float[] var3) {
      ...
      public CubicSpline<C, I> mapAll(CubicSpline.CoordinateVisitor<I> var1) {
         return create((BoundedFloatFunction)var1.visit(this.coordinate), this.locations, this.values().stream().map((var1x) -> {
