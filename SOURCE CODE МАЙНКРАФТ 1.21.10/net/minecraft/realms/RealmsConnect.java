      ...
      (new Thread("Realms-connect-task") {
         public void run() {
            ...
            try {
               ...
               DisconnectedScreen var6 = new DisconnectedScreen(RealmsConnect.this.onlineScreen, Component.translatable("mco.connect.failed"), Component.translatable("disconnect.genericReason", var3x), CommonComponents.GUI_BACK);
               var3.execute(() -> {
                  var3.setScreen(var6);
               });
            }
