...
public record PositionMoveRotation(Vec3 position, Vec3 deltaMovement, float yRot, float xRot) {
   ...
   public PositionMoveRotation(Vec3 param1, Vec3 param2, float param3, float param4) {
      super();
      this.position = var1;
   ...
   public static PositionMoveRotation calculateAbsolute(PositionMoveRotation var0, PositionMoveRotation var1, Set<Relative> var2) {
      double var3 = var2.contains(Relative.X) ? var0.position.x : 0.0D;
      double var5 = var2.contains(Relative.Y) ? var0.position.y : 0.0D;
      double var7 = var2.contains(Relative.Z) ? var0.position.z : 0.0D;
