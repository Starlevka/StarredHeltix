...
public class DragonStrafePlayerPhase extends AbstractDragonPhaseInstance {
   ...
   public void doServerTick(ServerLevel var1) {
      if (this.attackTarget == null) {
         ...
         var2 = this.targetLocation == null ? 0.0D : this.targetLocation.distanceToSqr(this.dragon.getX(), this.dragon.getY(), this.dragon.getZ());
         if (var2 < 100.0D || var2 > 22500.0D) {
            this.findNewTarget();
         }
         ...
         if (this.attackTarget.distanceToSqr(this.dragon) < 4096.0D) {
            if (this.dragon.hasLineOfSight(this.attackTarget)) {
               ++this.fireballCharge;
               Vec3 var27 = (new Vec3(this.attackTarget.getX() - this.dragon.getX(), 0.0D, this.attackTarget.getZ() - this.dragon.getZ())).normalize();
               Vec3 var7 = (new Vec3((double)Mth.sin(this.dragon.getYRot() * 0.017453292F), 0.0D, (double)(-Mth.cos(this.dragon.getYRot() * 0.017453292F)))).normalize();
               float var28 = (float)var7.dot(var27);
               float var9 = (float)(Math.acos((double)var28) * 57.2957763671875D);
               var9 += 0.5F;
               if (this.fireballCharge >= 5 && var9 >= 0.0F && var9 < 10.0F) {
                  var10 = 1.0D;
                  Vec3 var29 = this.dragon.getViewVector(1.0F);
                  double var13 = this.dragon.head.getX() - var29.x * 1.0D;
                  double var15 = this.dragon.head.getY(0.5D) + 0.5D;
                  double var17 = this.dragon.head.getZ() - var29.z * 1.0D;
                  double var19 = this.attackTarget.getX() - var13;
                  double var21 = this.attackTarget.getY(0.5D) - var15;
