...
public class DragonSittingScanningPhase extends AbstractDragonSittingPhase {
   ...
   public DragonSittingScanningPhase(EnderDragon var1) {
      super(var1);
      this.scanTargeting = TargetingConditions.forCombat().range(20.0D).selector((var1x, var2) -> {
   ...
   public void doServerTick(ServerLevel var1) {
      ...
      if (var2 != null) {
         if (this.scanningTime > 25) {
            ...
            Vec3 var3 = (new Vec3(var2.getX() - this.dragon.getX(), 0.0D, var2.getZ() - this.dragon.getZ())).normalize();
            Vec3 var4 = (new Vec3((double)Mth.sin(this.dragon.getYRot() * 0.017453292F), 0.0D, (double)(-Mth.cos(this.dragon.getYRot() * 0.017453292F)))).normalize();
            float var5 = (float)var4.dot(var3);
            float var6 = (float)(Math.acos((double)var5) * 57.2957763671875D) + 0.5F;
            if (var6 < 0.0F || var6 > 10.0F) {
               double var7 = var2.getX() - this.dragon.head.getX();
               double var9 = var2.getZ() - this.dragon.head.getZ();
               double var11 = Mth.clamp(Mth.wrapDegrees(180.0D - Mth.atan2(var7, var9) * 57.2957763671875D - (double)this.dragon.getYRot()), -100.0D, 100.0D);
         ...
         if (var2 != null) {
            ...
            ((DragonChargePlayerPhase)this.dragon.getPhaseManager().getPhase(EnderDragonPhase.CHARGING_PLAYER)).setTarget(new Vec3(var2.getX(), var2.getY(), var2.getZ()));
         }
      }
