...
public class DragonLandingApproachPhase extends AbstractDragonPhaseInstance {
   ...
   public void doServerTick(ServerLevel var1) {
      double var2 = this.targetLocation == null ? 0.0D : this.targetLocation.distanceToSqr(this.dragon.getX(), this.dragon.getY(), this.dragon.getZ());
      if (var2 < 100.0D || var2 > 22500.0D || this.dragon.horizontalCollision || this.dragon.verticalCollision) {
   ...
   private void findNewTarget(ServerLevel var1) {
      if (this.currentPath == null || this.currentPath.isDone()) {
         ...
         int var5;
         if (var4 != null) {
            Vec3 var6 = (new Vec3(var4.getX(), 0.0D, var4.getZ())).normalize();
            var5 = this.dragon.findClosestNode(-var6.x * 40.0D, 105.0D, -var6.z * 40.0D);
         } else {
            var5 = this.dragon.findClosestNode(40.0D, (double)var3.getY(), 0.0D);
         }
