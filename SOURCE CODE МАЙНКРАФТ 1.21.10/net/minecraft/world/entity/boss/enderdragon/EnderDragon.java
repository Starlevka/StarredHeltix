...
public class EnderDragon extends Mob implements Enemy {
   ...
   public void aiStep() {
      ...
      if (this.isDeadOrDying()) {
         ...
         this.level().addParticle(ParticleTypes.EXPLOSION, this.getX() + (double)var26, this.getY() + 2.0D + (double)var28, this.getZ() + (double)var30, 0.0D, 0.0D, 0.0D);
      } else {
         this.checkCrystals();
         Vec3 var25 = this.getDeltaMovement();
         var28 = 0.2F / ((float)var25.horizontalDistance() * 10.0F + 1.0F);
         var28 *= (float)Math.pow(2.0D, var25.y);
         ...
         if (this.isNoAi()) {
            ...
            if (var4 instanceof ServerLevel) {
               ...
               if (var5 != null) {
                  ...
                  this.setDeltaMovement(this.getDeltaMovement().add(0.0D, var8 * 0.01D, 0.0D));
                  this.setYRot(Mth.wrapDegrees(this.getYRot()));
                  ...
                  if (Math.abs(var6) > 9.999999747378752E-6D || Math.abs(var10) > 9.999999747378752E-6D) {
                  ...
                  var20 = (float)(2.0D / (var12 + 1.0D));
                  var21 = 0.06F;
                  this.moveRelative(0.06F * (var19 * var20 + (1.0F - var20)), new Vec3(0.0D, 0.0D, -1.0D));
                  if (this.inWall) {
                  ...
                  double var23 = 0.8D + 0.15D * (var22.dot(var18) + 1.0D) / 2.0D;
                  this.setDeltaMovement(this.getDeltaMovement().multiply(var23, 0.9100000262260437D, var23));
               }
            } else {
            ...
            this.tickPart(this.body, (double)(var36 * 0.5F), 0.0D, (double)(-var9 * 0.5F));
            this.tickPart(this.wing1, (double)(var9 * 4.5F), 2.0D, (double)(var36 * 4.5F));
            this.tickPart(this.wing2, (double)(var9 * -4.5F), 2.0D, (double)(var36 * -4.5F));
            Level var11 = this.level();
            if (var11 instanceof ServerLevel) {
               ServerLevel var37 = (ServerLevel)var11;
               if (this.hurtTime == 0) {
                  this.knockBack(var37, var37.getEntities(this, this.wing1.getBoundingBox().inflate(4.0D, 2.0D, 4.0D).move(0.0D, -2.0D, 0.0D), EntitySelector.NO_CREATIVE_OR_SPECTATOR));
                  this.knockBack(var37, var37.getEntities(this, this.wing2.getBoundingBox().inflate(4.0D, 2.0D, 4.0D).move(0.0D, -2.0D, 0.0D), EntitySelector.NO_CREATIVE_OR_SPECTATOR));
                  this.hurt(var37, var37.getEntities(this, this.head.getBoundingBox().inflate(1.0D), EntitySelector.NO_CREATIVE_OR_SPECTATOR));
                  this.hurt(var37, var37.getEntities(this, this.neck.getBoundingBox().inflate(1.0D), EntitySelector.NO_CREATIVE_OR_SPECTATOR));
               }
            }
            ...
            for(var41 = 0; var41 < 3; ++var41) {
               ...
               this.tickPart(var43, (double)(-(var36 * 1.5F + var46 * var21) * var33), var16.y() - var13.y() - (double)((var21 + 1.5F) * var35) + 1.5D, (double)((var9 * 1.5F + var19 * var21) * var33));
            }
   ...
   protected void tickDeath() {
      ...
      Vec3 var9 = new Vec3(0.0D, 0.10000000149011612D, 0.0D);
   ...
   protected void readAdditionalSaveData(ValueInput var1) {
      ...
      var1.getInt("DragonPhase").ifPresent((var1x) -> {
         this.phaseManager.setPhase(EnderDragonPhase.getById(var1x));
      });
