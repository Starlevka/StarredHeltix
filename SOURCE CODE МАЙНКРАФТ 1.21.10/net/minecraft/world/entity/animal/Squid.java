...
public class Squid extends AgeableWaterCreature {
   ...
   private void spawnInk() {
      ...
      for(int var2 = 0; var2 < 30; ++var2) {
         ...
         ((ServerLevel)this.level()).sendParticles(this.getInkParticle(), var1.x, var1.y + 0.5D, var1.z, 0, var5.x, var5.y, var5.z, 0.10000000149011612D);
      }
      ...
      public void tick() {
         ...
         if (var1 != null) {
            ...
            if (var4.is(FluidTags.WATER) || var3.isAir()) {
               ...
               Squid.this.movementVector = new Vec3(var2.x / 20.0D, var2.y / 20.0D, var2.z / 20.0D);
            }
