...
public class HappyGhastAi {
   ...
   private static void initIdleActivity(Brain<HappyGhast> var0) {
      var0.addActivity(Activity.IDLE, ImmutableList.of(Pair.of(1, new FollowTemptation((var0x) -> {
         return 1.25F;
      }, (var0x) -> {
         return 3.0D;
      }, true)), Pair.of(2, BabyFollowAdult.create(ADULT_FOLLOW_RANGE, (var0x) -> {
         return 1.1F;
      }, MemoryModuleType.NEAREST_VISIBLE_PLAYER, true)), Pair.of(3, BabyFollowAdult.create(ADULT_FOLLOW_RANGE, (var0x) -> {
         return 1.1F;
