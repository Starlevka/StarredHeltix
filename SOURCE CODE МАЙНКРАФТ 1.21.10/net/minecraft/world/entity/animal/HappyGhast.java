...
public class HappyGhast extends Animal {
   ...
   public static final Predicate<ItemStack> IS_FOOD = (var0) -> {
      return var0.is(ItemTags.HAPPY_GHAST_FOOD);
   };
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(4, new TemptGoal.ForNonPathfinders(this, 1.0D, (var1) -> {
         return !this.isWearingBodyArmor() && !this.isBaby() ? var1.is(ItemTags.HAPPY_GHAST_TEMPT_ITEMS) : IS_FOOD.test(var1);
      }, false, 7.0D));
