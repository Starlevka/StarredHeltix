...
public class Llama extends AbstractChestedHorse implements RangedAttackMob {
   ...
   protected void readAdditionalSaveData(ValueInput var1) {
      ...
      this.setVariant((Llama.Variant)var1.read("Variant", Llama.Variant.LEGACY_CODEC).orElse(Llama.Variant.DEFAULT));
   }
   ...
   private void setVariant(Llama.Variant var1) {
      this.entityData.set(DATA_VARIANT_ID, var1.id);
   }

   @Nullable
   public <T> T get(DataComponentType<? extends T> var1) {
      return var1 == DataComponents.LLAMA_VARIANT ? castComponentValue(var1, this.getVariant()) : super.get(var1);
   }
   ...
   protected <T> boolean applyImplicitComponent(DataComponentType<T> var1, T var2) {
      if (var1 == DataComponents.LLAMA_VARIANT) {
         this.setVariant((Llama.Variant)castComponentValue(DataComponents.LLAMA_VARIANT, var2));
         return true;
      } else {
   ...
   public static enum Variant implements StringRepresentable {
      ...
      static {
         ...
         LEGACY_CODEC = var10000.xmap(var10001::apply, Llama.Variant::getId);
         STREAM_CODEC = ByteBufCodecs.idMapper(BY_ID, Llama.Variant::getId);
      }
   }
