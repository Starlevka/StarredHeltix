...
public class Camel extends AbstractHorse {
      ...
      if (!this.isFood(var2)) {
         ...
         if (!var3 && !var4 && !var5) {
            ...
            if (!this.isSilent()) {
               ...
               if (var6 != null) {
                  this.level().playSound((Entity)null, this.getX(), this.getY(), this.getZ(), (SoundEvent)var6, this.getSoundSource(), 1.0F, 1.0F + (this.random.nextFloat() - this.random.nextFloat()) * 0.2F);
               }
            }
   ...
   protected Holder<SoundEvent> getEquipSound(EquipmentSlot var1, ItemStack var2, Equippable var3) {
      return (Holder)(var1 == EquipmentSlot.SADDLE ? SoundEvents.CAMEL_SADDLE : super.getEquipSound(var1, var2, var3));
   }
