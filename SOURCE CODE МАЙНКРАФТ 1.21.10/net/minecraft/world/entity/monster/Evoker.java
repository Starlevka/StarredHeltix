...
public class Evoker extends SpellcasterIllager {
   ...
   class EvokerSummonSpellGoal extends SpellcasterIllager.SpellcasterUseSpellGoal {
      ...
      public boolean canUse() {
         if (!super.canUse()) {
            ...
            int var1 = getServerLevel(Evoker.this.level()).getNearbyEntities(Vex.class, this.vexCountTargeting, Evoker.this, Evoker.this.getBoundingBox().inflate(16.0D)).size();
   ...
   public class EvokerWololoSpellGoal extends SpellcasterIllager.SpellcasterUseSpellGoal {
      private final TargetingConditions wololoTargeting = TargetingConditions.forNonCombat().range(16.0D).selector((var0, var1x) -> {
      ...
      public boolean canUse() {
         if (Evoker.this.getTarget() != null) {
            ...
            if (!var1.getGameRules().getBoolean(GameRules.RULE_MOBGRIEFING)) {
               ...
               List var2 = var1.getNearbyEntities(Sheep.class, this.wololoTargeting, Evoker.this, Evoker.this.getBoundingBox().inflate(16.0D, 4.0D, 16.0D));
               if (var2.isEmpty()) {
                  return false;
               } else {
