...
public enum ConversionType {
   ...
   void convertCommon(Mob var1, Mob var2, ConversionParams var3) {
      ...
      if (var1 instanceof AgeableMob) {
         AgeableMob var8 = (AgeableMob)var1;
         if (var2 instanceof AgeableMob) {
            AgeableMob var10 = (AgeableMob)var2;
      ...
      Iterator var6 = COMPONENTS_TO_COPY.iterator();

      while(var6.hasNext()) {
         DataComponentType var7 = (DataComponentType)var6.next();
      ...
      if (var1 instanceof Zombie) {
         Zombie var13 = (Zombie)var1;
         if (var13.canBreakDoors() && var2 instanceof Zombie) {
            Zombie var14 = (Zombie)var2;
