...
public final class EntitySelector {
   ...
   public static Predicate<Entity> pushableBy(Entity var0) {
      ...
      return (Predicate)(var2 == Team.CollisionRule.NEVER ? Predicates.alwaysFalse() : NO_SPECTATORS.and((var3) -> {
         if (!var3.isPushable()) {
            ...
            Team.CollisionRule var5 = var7 == null ? Team.CollisionRule.ALWAYS : var7.getCollisionRule();
   ...
   static {
      CAN_BE_COLLIDED_WITH = NO_SPECTATORS.and((var0) -> {
         return var0.canBeCollidedWith((Entity)null);
      });
