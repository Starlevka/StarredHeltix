...
public class PrimedTnt extends Entity implements TraceableEntity {
   ...
   public PrimedTnt(Level var1, double var2, double var4, double var6, @Nullable LivingEntity var8) {
      ...
      this.yo = var4;
      this.zo = var6;
      this.owner = EntityReference.of((UniquelyIdentifyable)var8);
   }
   ...
   private void explode() {
      ...
      if (var2 instanceof ServerLevel) {
         ...
         if (var1.getGameRules().getBoolean(GameRules.RULE_TNT_EXPLODES)) {
            this.level().explode(this, Explosion.getDefaultDamageSource(this.level(), this), this.usedPortal ? USED_PORTAL_DAMAGE_CALCULATOR : null, this.getX(), this.getY(0.0625D), this.getZ(), this.explosionPower, false, Level.ExplosionInteraction.TNT);
         }
      }
