...
public class ItemEntity extends Entity implements TraceableEntity {
   ...
   private void setFluidMovement(double var1) {
      Vec3 var3 = this.getDeltaMovement();
      this.setDeltaMovement(var3.x * var1, var3.y + (double)(var3.y < 0.05999999865889549D ? 5.0E-4F : 0.0F), var3.z * var1);
   }
   ...
   protected void readAdditionalSaveData(ValueInput var1) {
      ...
      this.thrower = EntityReference.read(var1, "Thrower");
   ...
   public void setThrower(Entity var1) {
      this.thrower = EntityReference.of((UniquelyIdentifyable)var1);
   }
