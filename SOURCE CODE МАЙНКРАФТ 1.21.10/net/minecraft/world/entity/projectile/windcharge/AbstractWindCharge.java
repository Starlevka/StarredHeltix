...
public abstract class AbstractWindCharge extends AbstractHurtingProjectile implements ItemSupplier {
   ...
   protected AABB makeBoundingBox(Vec3 var1) {
      ...
      float var4 = 0.15F;
      return new AABB(var1.x - (double)var2, var1.y - 0.15000000596046448D, var1.z - (double)var2, var1.x + (double)var2, var1.y - 0.15000000596046448D + (double)var3, var1.z + (double)var2);
   }
   ...
   protected void onHitEntity(EntityHitResult var1) {
      ...
      if (var3 instanceof ServerLevel) {
         ...
         if (var8.hurtServer(var2, var9, 1.0F) && var8 instanceof LivingEntity) {
            LivingEntity var6 = (LivingEntity)var8;
