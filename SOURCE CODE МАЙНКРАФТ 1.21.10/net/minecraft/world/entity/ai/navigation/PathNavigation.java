...
public abstract class PathNavigation {
   ...
   public PathNavigation(Mob var1, Level var2) {
      ...
      this.mob = var1;
      this.level = var2;
      this.pathFinder = this.createPathFinder(Mth.floor(var1.getAttributeBaseValue(Attributes.FOLLOW_RANGE) * 16.0D));
      if (var2 instanceof ServerLevel) {
         ...
         this.pathFinder.setCaptureDebug(() -> {
            return var4.hasAnySubscriberFor(DebugSubscriptions.ENTITY_PATHS);
         });
      }
