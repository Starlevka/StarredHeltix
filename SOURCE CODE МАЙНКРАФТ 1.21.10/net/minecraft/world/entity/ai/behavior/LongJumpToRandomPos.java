...
public class LongJumpToRandomPos<E extends Mob> extends Behavior<E> {
   ...
   protected Optional<LongJumpToRandomPos.PossibleJump> getJumpCandidate(ServerLevel var1) {
      Optional var2 = WeightedRandom.getRandomItem(var1.random, this.jumpCandidates, LongJumpToRandomPos.PossibleJump::weight);
   ...
   public static record PossibleJump(BlockPos targetPos, int weight) {
      public PossibleJump(BlockPos param1, int param2) {
         super();
         this.targetPos = var1;
         this.weight = var2;
      }
