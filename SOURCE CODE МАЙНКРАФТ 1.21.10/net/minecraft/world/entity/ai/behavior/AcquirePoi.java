...
public class AcquirePoi {
   ...
   public static BehaviorControl<PathfinderMob> create(Predicate<Holder<PoiType>> var0, MemoryModuleType<GlobalPos> var1, boolean var2, Optional<Byte> var3) {
      return create(var0, var1, var1, var2, var3, (var0x, var1x) -> {
         return true;
      });
   }
   ...
   public static BehaviorControl<PathfinderMob> create(Predicate<Holder<PoiType>> var0, MemoryModuleType<GlobalPos> var1, MemoryModuleType<GlobalPos> var2, boolean var3, Optional<Byte> var4, BiPredicate<ServerLevel, BlockPos> var5) {
      ...
      OneShot var10 = BehaviorBuilder.create((var7x) -> {
         return var7x.group(var7x.absent(var2)).apply(var7x, (var6) -> {
            return (var7, var8x, var9x) -> {
               if (var3 && var8x.isBaby()) {
                  ...
                  var9.long2ObjectEntrySet().removeIf((var2) -> {
                     return !((AcquirePoi.JitteredLinearRetry)var2.getValue()).isStillValid(var9x);
                  });
                  Predicate var12 = (var3x) -> {
                     AcquirePoi.JitteredLinearRetry var4 = (AcquirePoi.JitteredLinearRetry)var9.get(var3x.asLong());
                     if (var4 == null) {
                        return true;
                  ...
                  Set var13 = (Set)var11.findAllClosestFirstWithType(var0, var12, var8x.blockPosition(), 48, PoiManager.Occupancy.HAS_SPACE).limit(5L).filter((var2) -> {
                     return var5.test(var7, (BlockPos)var2.getSecond());
                  ...
                  if (var14 != null && var14.canReach()) {
                     ...
                     var11.getType(var17).ifPresent((var8xx) -> {
                        var11.take(var0, (var1, var2) -> {
                           return var2.equals(var17);
                        }, var17, 1);
                        var6.set(GlobalPos.of(var7.dimension(), var17));
                        var4.ifPresent((var2) -> {
                           var7.broadcastEntityEvent(var8x, var2);
                        });
                        var9.clear();
                     ...
                     while(var15.hasNext()) {
                        Pair var16 = (Pair)var15.next();
                        var9.computeIfAbsent(((BlockPos)var16.getSecond()).asLong(), (var3x) -> {
                           return new AcquirePoi.JitteredLinearRetry(var7.random, var9x);
                        });
                     }
                  }
      ...
      return var2 == var1 ? var10 : BehaviorBuilder.create((var2x) -> {
