...
public class VillagerGoalPackages {
   ...
   public static ImmutableList<Pair<Integer, ? extends BehaviorControl<? super Villager>>> getCorePackage(Holder<VillagerProfession> var0, float var1) {
      return ImmutableList.of(Pair.of(0, new Swim(0.8F)), Pair.of(0, InteractWithDoor.create()), Pair.of(0, new LookAtTargetSink(45, 90)), Pair.of(0, new VillagerPanicTrigger()), Pair.of(0, WakeUp.create()), Pair.of(0, ReactToBell.create()), Pair.of(0, SetRaidStatus.create()), Pair.of(0, ValidateNearbyPoi.create(((VillagerProfession)var0.value()).heldJobSite(), MemoryModuleType.JOB_SITE)), Pair.of(0, ValidateNearbyPoi.create(((VillagerProfession)var0.value()).acquirableJobSite(), MemoryModuleType.POTENTIAL_JOB_SITE)), Pair.of(1, new MoveToTargetSink()), Pair.of(2, PoiCompetitorScan.create()), Pair.of(3, new LookAndFollowTradingPlayerSink(var1)), new Pair[]{Pair.of(5, GoToWantedItem.create(var1, false, 4)), Pair.of(6, AcquirePoi.create(((VillagerProfession)var0.value()).acquirableJobSite(), MemoryModuleType.JOB_SITE, MemoryModuleType.POTENTIAL_JOB_SITE, true, Optional.empty(), (var0x, var1x) -> {
         return true;
      })), Pair.of(7, new GoToPotentialJobSite(var1)), Pair.of(8, YieldJobSite.create(var1)), Pair.of(10, AcquirePoi.create((var0x) -> {
         return var0x.is(PoiTypes.HOME);
      }, MemoryModuleType.HOME, false, Optional.of((byte)14), VillagerGoalPackages::validateBedPoi)), Pair.of(10, AcquirePoi.create((var0x) -> {
