...
public final class LongJumpUtil {
   ...
   public static Optional<Vec3> calculateJumpVectorForAngle(Mob var0, Vec3 var1, float var2, int var3, boolean var4) {
      ...
      Vec3 var6 = (new Vec3(var1.x - var5.x, 0.0D, var1.z - var5.z)).normalize().scale(0.5D);
         ...
         if (var34 > (double)var2) {
            ...
            if (var4) {
               ...
               for(int var45 = 0; var45 < var40 - 1; ++var45) {
                  ...
                  double var46 = var24 / var26 * var41 - Math.pow(var41, 2.0D) * var18 / (2.0D * var32 * Math.pow(var26, 2.0D));
            ...
            return Optional.of((new Vec3(var36 * var30, var38, var36 * var28)).scale(0.949999988079071D));
         }
      }
   }
   ...
   private static boolean isClearTransition(Mob var0, EntityDimensions var1, Vec3 var2, Vec3 var3) {
      ...
      for(int var10 = 0; var10 < var7; ++var10) {
         var9 = var10 == var7 - 1 ? var3 : var9.add(var8.scale(var5 * 0.8999999761581421D));
