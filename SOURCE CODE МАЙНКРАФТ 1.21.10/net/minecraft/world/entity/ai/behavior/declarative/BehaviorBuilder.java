...
public class BehaviorBuilder<E extends LivingEntity, M> implements App<BehaviorBuilder.Mu<E>, M> {
   ...
   public static final class Instance<E extends LivingEntity> implements Applicative<BehaviorBuilder.Mu<E>, BehaviorBuilder.Instance.Mu<E>> {
      ...
      // $FF: synthetic method
      public App ap4(final App param1, final App param2, final App param3, final App param4, final App param5) {
         return this.ap4(var1, var2, var3, var4, var5);
      }

      // $FF: synthetic method
      public App ap3(final App param1, final App param2, final App param3, final App param4) {
         return this.ap3(var1, var2, var3, var4);
      }

      // $FF: synthetic method
      public App ap2(final App param1, final App param2, final App param3) {
         return this.ap2(var1, var2, var3);
      }

      // $FF: synthetic method
      public App point(final Object param1) {
         return this.point(var1);
      }

      // $FF: synthetic method
      public App map(final Function param1, final App param2) {
   ...
   private static final class TriggerWrapper<E extends LivingEntity> extends BehaviorBuilder<E, Unit> {
      TriggerWrapper(final Trigger<? super E> var1) {
         super(new BehaviorBuilder.TriggerWithResult<E, Unit>() {
            ...
            // $FF: synthetic method
            @Nullable
            public Object tryTrigger(final ServerLevel param1, final LivingEntity param2, final long param3) {
