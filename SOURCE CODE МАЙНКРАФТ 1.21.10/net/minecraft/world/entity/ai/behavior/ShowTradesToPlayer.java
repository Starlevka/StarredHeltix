...
public class ShowTradesToPlayer extends Behavior<Villager> {
   ...
   // $FF: synthetic method
   public void stop(final ServerLevel param1, final LivingEntity param2, final long param3) {
      this.stop(var1, (Villager)var2, var3);
   }

   // $FF: synthetic method
   public void start(final ServerLevel param1, final LivingEntity param2, final long param3) {
