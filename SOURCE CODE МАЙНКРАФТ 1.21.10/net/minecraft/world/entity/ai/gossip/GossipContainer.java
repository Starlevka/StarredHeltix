...
public class GossipContainer {
   ...
   private GossipContainer(List<GossipContainer.GossipEntry> var1) {
      super();
      var1.forEach((var1x) -> {
   ...
   public void putAll(GossipContainer var1) {
      var1.gossips.forEach((var1x, var2) -> {
         this.getOrCreate(var1x).entries.putAll(var2.entries);
      });
   }
   ...
   static {
      CODEC = GossipContainer.GossipEntry.CODEC.listOf().xmap(GossipContainer::new, (var0) -> {
         return var0.unpack().toList();
      });
   }
