...
public abstract class AbstractContainerMenu {
   ...
   public void setSynchronizer(ContainerSynchronizer var1) {
      ...
      this.remoteSlots.replaceAll((var1x) -> {
         return var1.createSlot();
      });
   ...
   public void sendAllDataToRemote() {
      ...
      int var3;
      for(var3 = this.slots.size(); var2 < var3; ++var2) {
      ...
      for(int var6 = this.dataSlots.size(); var3 < var6; ++var3) {
         this.remoteDataSlots.set(var3, ((DataSlot)this.dataSlots.get(var3)).get());
      }
   ...
   private void synchronizeSlotToRemote(int var1, ItemStack var2, java.util.function.Supplier<ItemStack> var3) {
      if (!this.suppressRemoteUpdates) {
         RemoteSlot var4 = (RemoteSlot)this.remoteSlots.get(var1);
   ...
   private static void dropOrPlaceInInventory(Player var0, ItemStack var1) {
      ...
      label27: {
         ...
         if (var0 instanceof ServerPlayer) {
            ServerPlayer var4 = (ServerPlayer)var0;
   ...
   public void transferState(AbstractContainerMenu var1) {
      ...
      for(var3 = 0; var3 < this.slots.size(); ++var3) {
         ...
         if (var5 != null) {
            ...
            RemoteSlot var6 = (RemoteSlot)var1.remoteSlots.get(var5);
            RemoteSlot var7 = (RemoteSlot)this.remoteSlots.get(var3);
