...
public record LootDataType<T>(ResourceKey<Registry<T>> registryKey, Codec<T> codec, LootDataType.Validator<T> validator) {
   ...
   private static <T extends LootContextUser> LootDataType.Validator<T> createSimpleValidator() {
      return (var0, var1, var2) -> {
         var2.validate(var0.enterElement(new ProblemReporter.RootElementPathElement(var1), var1));
      };
   }

   private static LootDataType.Validator<LootTable> createLootTableValidator() {
      return (var0, var1, var2) -> {
         var2.validate(var0.setContextKeySet(var2.getParamSet()).enterElement(new ProblemReporter.RootElementPathElement(var1), var1));
      };
   }
