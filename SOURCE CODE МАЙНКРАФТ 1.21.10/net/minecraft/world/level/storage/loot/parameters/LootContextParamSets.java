...
public class LootContextParamSets {
   ...
   static {
      ...
      ENTITY_INTERACT = register("entity_interact", (var0) -> {
         var0.required(LootContextParams.TARGET_ENTITY).optional(LootContextParams.INTERACTING_ENTITY).required(LootContextParams.TOOL);
      });
      BLOCK_INTERACT = register("block_interact", (var0) -> {
         var0.required(LootContextParams.BLOCK_STATE).optional(LootContextParams.BLOCK_ENTITY).optional(LootContextParams.INTERACTING_ENTITY).optional(LootContextParams.TOOL);
      });
