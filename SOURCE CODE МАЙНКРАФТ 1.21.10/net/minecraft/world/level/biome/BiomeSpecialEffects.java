...
public class BiomeSpecialEffects {
   public static final Codec<BiomeSpecialEffects> CODEC = RecordCodecBuilder.create((var0) -> {
      ...
      }), Codec.INT.optionalFieldOf("dry_foliage_color").forGetter((var0x) -> {
         return var0x.dryFoliageColorOverride;
      ...
      }), WeightedList.codec(Music.CODEC).optionalFieldOf("music").forGetter((var0x) -> {
   ...
   public static class Builder {
      ...
      public BiomeSpecialEffects.Builder backgroundMusic(@Nullable Music var1) {
         if (var1 == null) {
            ...
            this.backgroundMusic = Optional.of(WeightedList.of((Object)var1));
            return this;
         }
      }
      ...
      public BiomeSpecialEffects.Builder backgroundMusic(WeightedList<Music> var1) {
         this.backgroundMusic = Optional.of(var1);
         return this;
      }

      public BiomeSpecialEffects.Builder backgroundMusicVolume(float var1) {
