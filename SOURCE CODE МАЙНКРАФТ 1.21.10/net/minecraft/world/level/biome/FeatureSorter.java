...
public class FeatureSorter {
   ...
   public static <T> List<FeatureSorter.StepFeatureData> buildFeaturesPerStep(List<T> var0, Function<T, List<HolderSet<PlacedFeature>>> var1, boolean var2) {
      ...
      record 1FeatureData(int featureIndex, int step, PlacedFeature feature) {
         _FeatureData/* $FF was: 1FeatureData*/(int param1, int param2, PlacedFeature param3) {
            super();
   ...
   public static record StepFeatureData(List<PlacedFeature> features, ToIntFunction<PlacedFeature> indexMapping) {
      ...
      public StepFeatureData(List<PlacedFeature> param1, ToIntFunction<PlacedFeature> param2) {
         super();
         this.features = var1;
