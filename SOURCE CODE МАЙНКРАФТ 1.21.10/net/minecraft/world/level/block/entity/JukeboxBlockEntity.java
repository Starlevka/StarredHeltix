...
public class JukeboxBlockEntity extends BlockEntity implements ContainerSingleItem.BlockContainerSingleItem {
   ...
   protected void loadAdditional(ValueInput var1) {
      ...
      this.item = var2;
      var1.getLong("ticks_since_song_started").ifPresent((var2x) -> {
         JukeboxSong.fromStack(var1.lookup(), this.item).ifPresent((var2) -> {
            this.jukeboxSongPlayer.setSongWithoutPlaying(var2, var2x);
         });
      });
   }
