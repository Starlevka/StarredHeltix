...
public record TrialSpawnerConfig(int spawnRange, float totalMobs, float simultaneousMobs, float totalMobsAddedPerPlayer, float simultaneousMobsAddedPerPlayer, int ticksBetweenSpawn, WeightedList<SpawnData> spawnPotentialsDefinition, WeightedList<ResourceKey<LootTable>> lootTablesToEject, ResourceKey<LootTable> itemsToDropWhenOminous) {
   ...
   public TrialSpawnerConfig(int param1, float param2, float param3, float param4, float param5, int param6, WeightedList<SpawnData> param7, WeightedList<ResourceKey<LootTable>> param8, ResourceKey<LootTable> param9) {
      super();
   ...
   public TrialSpawnerConfig withSpawning(EntityType<?> var1) {
      ...
      return new TrialSpawnerConfig(this.spawnRange, this.totalMobs, this.simultaneousMobs, this.totalMobsAddedPerPlayer, this.simultaneousMobsAddedPerPlayer, this.ticksBetweenSpawn, WeightedList.of((Object)var3), this.lootTablesToEject, this.itemsToDropWhenOminous);
   }
   ...
   public WeightedList<SpawnData> spawnPotentialsDefinition() {
      return this.spawnPotentialsDefinition;
   }

   public WeightedList<ResourceKey<LootTable>> lootTablesToEject() {
   ...
   public static class Builder {
      ...
      public TrialSpawnerConfig.Builder spawnRange(int var1) {
         this.spawnRange = var1;
         return this;
      }

      public TrialSpawnerConfig.Builder totalMobs(float var1) {
         this.totalMobs = var1;
         return this;
      }

      public TrialSpawnerConfig.Builder simultaneousMobs(float var1) {
         this.simultaneousMobs = var1;
         return this;
      }

      public TrialSpawnerConfig.Builder totalMobsAddedPerPlayer(float var1) {
         this.totalMobsAddedPerPlayer = var1;
         return this;
      }

      public TrialSpawnerConfig.Builder simultaneousMobsAddedPerPlayer(float var1) {
         this.simultaneousMobsAddedPerPlayer = var1;
         return this;
      }

      public TrialSpawnerConfig.Builder ticksBetweenSpawn(int var1) {
         this.ticksBetweenSpawn = var1;
         return this;
      }

      public TrialSpawnerConfig.Builder spawnPotentialsDefinition(WeightedList<SpawnData> var1) {
         this.spawnPotentialsDefinition = var1;
         return this;
      }

      public TrialSpawnerConfig.Builder lootTablesToEject(WeightedList<ResourceKey<LootTable>> var1) {
         this.lootTablesToEject = var1;
         return this;
      }

      public TrialSpawnerConfig.Builder itemsToDropWhenOminous(ResourceKey<LootTable> var1) {
