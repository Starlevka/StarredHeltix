...
public class Orientation {
   ...
   private static Orientation generateContext(Orientation var0, Orientation[] var1) {
      if (var1[var0.getIndex()] != null) {
         ...
         Orientation.SideBias[] var2 = Orientation.SideBias.values();
         int var3 = var2.length;

         int var4;
         for(var4 = 0; var4 < var3; ++var4) {
            Orientation.SideBias var5 = var2[var4];
   ...
   public static enum SideBias {
      ...
      // $FF: synthetic method
      private static Orientation.SideBias[] $values() {
         return new Orientation.SideBias[]{LEFT, RIGHT};
      }
   }
}
