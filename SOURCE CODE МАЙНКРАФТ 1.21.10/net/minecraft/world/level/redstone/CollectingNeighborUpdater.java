...
public class CollectingNeighborUpdater implements NeighborUpdater {
   ...
   private static record ShapeUpdate(Direction direction, BlockState neighborState, BlockPos pos, BlockPos neighborPos, int updateFlags, int updateLimit) implements CollectingNeighborUpdater.NeighborUpdates {
   ...
   static record SimpleNeighborUpdate(BlockPos pos, Block block, @Nullable Orientation orientation) implements CollectingNeighborUpdater.NeighborUpdates {
      SimpleNeighborUpdate(BlockPos param1, Block param2, @Nullable Orientation param3) {
         super();
         this.pos = var1;
         this.block = var2;
   ...
   static record FullNeighborUpdate(BlockState state, BlockPos pos, Block block, @Nullable Orientation orientation, boolean movedByPiston) implements CollectingNeighborUpdater.NeighborUpdates {
      FullNeighborUpdate(BlockState param1, BlockPos param2, Block param3, @Nullable Orientation param4, boolean param5) {
         super();
         this.state = var1;
         this.pos = var2;
         this.block = var3;
   ...
   static final class MultiNeighborUpdate implements CollectingNeighborUpdater.NeighborUpdates {
      ...
      public void forEachUpdatedPos(Consumer<BlockPos> var1) {
         Direction[] var2 = NeighborUpdater.UPDATE_ORDER;
