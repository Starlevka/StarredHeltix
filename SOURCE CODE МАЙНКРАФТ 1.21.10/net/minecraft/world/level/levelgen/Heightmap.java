...
public class Heightmap {
   ...
   public static enum Types implements StringRepresentable {
      ...
      MOTION_BLOCKING(4, "MOTION_BLOCKING", Heightmap.Usage.CLIENT, (var0) -> {
         return var0.blocksMotion() || !var0.getFluidState().isEmpty();
      }),
      MOTION_BLOCKING_NO_LEAVES(5, "MOTION_BLOCKING_NO_LEAVES", Heightmap.Usage.CLIENT, (var0) -> {
      ...
      private static final IntFunction<Heightmap.Types> BY_ID = ByIdMap.continuous((var0) -> {
         return var0.id;
      }, values(), ByIdMap.OutOfBoundsStrategy.ZERO);
      public static final StreamCodec<ByteBuf, Heightmap.Types> STREAM_CODEC = ByteBufCodecs.idMapper(BY_ID, (var0) -> {
         return var0.id;
      });
