...
public class BoundingBox {
   ...
   static {
      ...
      STREAM_CODEC = StreamCodec.composite(BlockPos.STREAM_CODEC, (var0) -> {
         return new BlockPos(var0.minX, var0.minY, var0.minZ);
      }, BlockPos.STREAM_CODEC, (var0) -> {
         return new BlockPos(var0.maxX, var0.maxY, var0.maxZ);
      }, (var0, var1) -> {
         return new BoundingBox(var0.getX(), var0.getY(), var0.getZ(), var1.getX(), var1.getY(), var1.getZ());
      });
   }
}
