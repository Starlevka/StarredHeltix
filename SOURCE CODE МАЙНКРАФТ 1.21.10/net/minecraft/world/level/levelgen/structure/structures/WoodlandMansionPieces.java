   ...
   public static class WoodlandMansionPiece extends TemplateStructurePiece {
      ...
      public WoodlandMansionPiece(StructureTemplateManager var1, CompoundTag var2) {
         super(StructurePieceType.WOODLAND_MANSION_PIECE, var2, var1, (var1x) -> {
            return makeSettings((Mirror)var2.read("Mi", Mirror.LEGACY_CODEC).orElseThrow(), (Rotation)var2.read("Rot", Rotation.LEGACY_CODEC).orElseThrow());
         });
      }
      ...
      protected void addAdditionalSaveData(StructurePieceSerializationContext var1, CompoundTag var2) {
         ...
         var2.store((String)"Mi", (Codec)Mirror.LEGACY_CODEC, this.placeSettings.getMirror());
      }
