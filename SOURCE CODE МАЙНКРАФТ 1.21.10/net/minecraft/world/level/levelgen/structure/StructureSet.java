...
public record StructureSet(List<StructureSet.StructureSelectionEntry> structures, StructurePlacement placement) {
   ...
   public StructureSet(List<StructureSet.StructureSelectionEntry> param1, StructurePlacement param2) {
      super();
   ...
   public static record StructureSelectionEntry(Holder<Structure> structure, int weight) {
      ...
      public StructureSelectionEntry(Holder<Structure> param1, int param2) {
         super();
         this.structure = var1;
         this.weight = var2;
      }
