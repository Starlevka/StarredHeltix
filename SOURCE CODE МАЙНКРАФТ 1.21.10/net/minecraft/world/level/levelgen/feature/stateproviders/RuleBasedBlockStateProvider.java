...
public record RuleBasedBlockStateProvider(BlockStateProvider fallback, List<RuleBasedBlockStateProvider.Rule> rules) {
   ...
   public RuleBasedBlockStateProvider(BlockStateProvider param1, List<RuleBasedBlockStateProvider.Rule> param2) {
      super();
      this.fallback = var1;
      this.rules = var2;
   }
   ...
   public static record Rule(BlockPredicate ifTrue, BlockStateProvider then) {
      ...
      public Rule(BlockPredicate param1, BlockStateProvider param2) {
         super();
         this.ifTrue = var1;
         this.then = var2;
      }
