...
public record BlockColumnConfiguration(List<BlockColumnConfiguration.Layer> layers, Direction direction, BlockPredicate allowedPlacement, boolean prioritizeTip) implements FeatureConfiguration {
   ...
   public BlockColumnConfiguration(List<BlockColumnConfiguration.Layer> param1, Direction param2, BlockPredicate param3, boolean param4) {
      super();
      this.layers = var1;
      this.direction = var2;
   ...
   public static record Layer(IntProvider height, BlockStateProvider state) {
      ...
      public Layer(IntProvider param1, BlockStateProvider param2) {
         super();
         this.height = var1;
         this.state = var2;
      }
