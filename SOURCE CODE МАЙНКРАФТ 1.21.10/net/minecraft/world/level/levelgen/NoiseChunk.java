...
public class NoiseChunk implements DensityFunction.ContextProvider, DensityFunction.FunctionContext {
   ...
   public NoiseChunk(int var1, RandomState var2, int var3, int var4, NoiseSettings var5, DensityFunctions.BeardifierOrMarker var6, NoiseGeneratorSettings var7, Aquifer.FluidPicker var8, Blender var9) {
      ...
      this.blockStateRule = new MaterialRuleList((NoiseChunk.BlockStateFiller[])var19.toArray(new NoiseChunk.BlockStateFiller[0]));
   }
   ...
   public void selectCellYZ(int var1, int var2) {
      ...
      while(var3.hasNext()) {
         NoiseChunk.NoiseInterpolator var4 = (NoiseChunk.NoiseInterpolator)var3.next();
      ...
      while(var3.hasNext()) {
         NoiseChunk.CacheAllInCell var5 = (NoiseChunk.CacheAllInCell)var3.next();
   ...
   public void updateForY(int var1, double var2) {
      ...
      while(var4.hasNext()) {
         NoiseChunk.NoiseInterpolator var5 = (NoiseChunk.NoiseInterpolator)var4.next();
