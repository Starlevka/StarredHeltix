...
public final class DensityFunctions {
   ...
   public static DensityFunction findTopSurface(DensityFunction var0, DensityFunction var1, int var2, int var3) {
      return new DensityFunctions.FindTopSurface(var0, var1, var2, var3);
   }
   ...
   protected static record Mapped(DensityFunctions.Mapped.Type type, DensityFunction input, double minValue, double maxValue) implements DensityFunctions.PureTransformer {
      ...
      public static DensityFunctions.Mapped create(DensityFunctions.Mapped.Type var0, DensityFunction var1) {
         ...
         if (var0 == DensityFunctions.Mapped.Type.INVERT) {
            return var2 < 0.0D && var4 > 0.0D ? new DensityFunctions.Mapped(var0, var1, -1.0D / 0.0, 1.0D / 0.0) : new DensityFunctions.Mapped(var0, var1, var8, var6);
         } else {
            return var0 != DensityFunctions.Mapped.Type.ABS && var0 != DensityFunctions.Mapped.Type.SQUARE ? new DensityFunctions.Mapped(var0, var1, var6, var8) : new DensityFunctions.Mapped(var0, var1, Math.max(0.0D, var2), Math.max(var6, var8));
         }
      }
      ...
      static enum Type implements StringRepresentable {
         ...
         private static DensityFunctions.Mapped.Type[] $values() {
            return new DensityFunctions.Mapped.Type[]{ABS, SQUARE, CUBE, HALF_NEGATIVE, QUARTER_NEGATIVE, INVERT, SQUEEZE};
         }
      }
   }
   ...
   static record FindTopSurface(DensityFunction density, DensityFunction upperBound, int lowerBound, int cellHeight) implements DensityFunction {
      private static final MapCodec<DensityFunctions.FindTopSurface> DATA_CODEC = RecordCodecBuilder.mapCodec((var0) -> {
         return var0.group(DensityFunction.HOLDER_HELPER_CODEC.fieldOf("density").forGetter(DensityFunctions.FindTopSurface::density), DensityFunction.HOLDER_HELPER_CODEC.fieldOf("upper_bound").forGetter(DensityFunctions.FindTopSurface::upperBound), Codec.intRange(DimensionType.MIN_Y * 2, DimensionType.MAX_Y * 2).fieldOf("lower_bound").forGetter(DensityFunctions.FindTopSurface::lowerBound), ExtraCodecs.POSITIVE_INT.fieldOf("cell_height").forGetter(DensityFunctions.FindTopSurface::cellHeight)).apply(var0, DensityFunctions.FindTopSurface::new);
      });
      public static final KeyDispatchDataCodec<DensityFunctions.FindTopSurface> CODEC;

      FindTopSurface(DensityFunction param1, DensityFunction param2, int param3, int param4) {
         super();
         this.density = var1;
      ...
      public double compute(DensityFunction.FunctionContext var1) {
         ...
         if (var2 <= this.lowerBound) {
            ...
            for(int var3 = var2; var3 >= this.lowerBound; var3 -= this.cellHeight) {
               if (this.density.compute(new DensityFunction.SinglePointContext(var1.blockX(), var3, var1.blockZ())) > 0.0D) {
                  return (double)var3;
               }
            }
      ...
      public DensityFunction mapAll(DensityFunction.Visitor var1) {
         return var1.apply(new DensityFunctions.FindTopSurface(this.density.mapAll(var1), this.upperBound.mapAll(var1), this.lowerBound, this.cellHeight));
      }
      ...
      public DensityFunction upperBound() {
