...
public record ChunkPyramid(ImmutableList<ChunkStep> steps) {
   ...
   public ChunkPyramid(ImmutableList<ChunkStep> param1) {
      super();
      this.steps = var1;
   }
   ...
   static {
      GENERATION_PYRAMID = (new ChunkPyramid.Builder()).step(ChunkStatus.EMPTY, (var0) -> {
         return var0;
      ...
      LOADING_PYRAMID = (new ChunkPyramid.Builder()).step(ChunkStatus.EMPTY, (var0) -> {
         return var0;
      }).step(ChunkStatus.STRUCTURE_STARTS, (var0) -> {
