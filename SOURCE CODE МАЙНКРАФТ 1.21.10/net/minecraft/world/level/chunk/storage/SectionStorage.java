...
public class SectionStorage<R, P> implements AutoCloseable {
      ...
      synchronized(this.loadLock) {
         ...
         while(var2.hasNext()) {
            ...
            if (var4 != null) {
               ...
               this.unpackChunk(new ChunkPos(var5), (SectionStorage.PackedChunk)var4.orElse((Object)null));
               var2.remove();
   ...
   private void unpackChunk(ChunkPos var1) {
      ...
      this.unpackChunk(var1, (SectionStorage.PackedChunk)((Optional)var4.join()).orElse((Object)null));
      synchronized(this.loadLock) {
   ...
   private CompletableFuture<Optional<SectionStorage.PackedChunk<P>>> tryRead(ChunkPos var1) {
      ...
      return this.simpleRegionStorage.read(var1).thenApplyAsync((var2x) -> {
         ...
         if (var2x instanceof IOException) {
            IOException var3 = (IOException)var2x;
   ...
   private static record PackedChunk<T>(Int2ObjectMap<T> sectionsByY, boolean versionChanged) {
      ...
      private PackedChunk(Int2ObjectMap<T> param1, boolean param2) {
         super();
         this.sectionsByY = var1;
         this.versionChanged = var2;
      }

      public static <T> SectionStorage.PackedChunk<T> parse(Codec<T> var0, DynamicOps<Tag> var1, Tag var2, SimpleRegionStorage var3, LevelHeightAccessor var4) {
         ...
         return new SectionStorage.PackedChunk(var9, var7);
      }
