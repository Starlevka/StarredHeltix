...
public class Vec3 implements Position {
   ...
   public Vec3 normalize() {
      ...
      return var1 < 9.999999747378752E-6D ? ZERO : new Vec3(this.x / var1, this.y / var1, this.z / var1);
   }
   ...
   public Vec3 projectedOn(Vec3 var1) {
      return var1.lengthSqr() == 0.0D ? var1 : var1.scale(this.dot(var1)).scale(1.0D / var1.lengthSqr());
   }
   ...
   static {
      ...
      X_AXIS = new Vec3(1.0D, 0.0D, 0.0D);
      Y_AXIS = new Vec3(0.0D, 1.0D, 0.0D);
      Z_AXIS = new Vec3(0.0D, 0.0D, 1.0D);
   }
}
