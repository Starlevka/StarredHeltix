      ...
      if (!(var3 instanceof Player)) {
         ...
         if (var6.isEmpty()) {
            ...
            if ((double)var8 < 0.1D) {
               ...
               var2.playSound((Entity)null, var5.getX(), var5.getY(), var5.getZ(), (SoundEvent)SoundEvents.ARROW_SHOOT, SoundSource.PLAYERS, 1.0F, 1.0F / (var2.getRandom().nextFloat() * 0.4F + 1.2F) + var8 * 0.5F);
