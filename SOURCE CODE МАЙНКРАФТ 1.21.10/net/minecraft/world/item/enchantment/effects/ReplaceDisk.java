...
public record ReplaceDisk(LevelBasedValue radius, LevelBasedValue height, Vec3i offset, Optional<BlockPredicate> predicate, BlockStateProvider blockState, Optional<Holder<GameEvent>> triggerGameEvent) implements EnchantmentEntityEffect {
   ...
   public ReplaceDisk(LevelBasedValue param1, LevelBasedValue param2, Vec3i param3, Optional<BlockPredicate> param4, BlockStateProvider param5, Optional<Holder<GameEvent>> param6) {
      super();
      this.radius = var1;
      this.height = var2;
      this.offset = var3;
   ...
   public void apply(ServerLevel var1, int var2, EnchantedItemInUse var3, Entity var4, Vec3 var5) {
      ...
      while(var10.hasNext()) {
         ...
         if (var11.distToCenterSqr(var5.x(), (double)var11.getY() + 0.5D, var5.z()) < (double)Mth.square(var8) && (Boolean)this.predicate.map((var2x) -> {
