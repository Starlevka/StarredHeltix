...
public record ExplodeEffect(boolean attributeToUser, Optional<Holder<DamageType>> damageType, Optional<LevelBasedValue> knockbackMultiplier, Optional<HolderSet<Block>> immuneBlocks, Vec3 offset, LevelBasedValue radius, boolean createFire, Level.ExplosionInteraction blockInteraction, ParticleOptions smallParticle, ParticleOptions largeParticle, WeightedList<ExplosionParticleInfo> blockParticles, Holder<SoundEvent> sound) implements EnchantmentEntityEffect {
   ...
   public ExplodeEffect(boolean param1, Optional<Holder<DamageType>> param2, Optional<LevelBasedValue> param3, Optional<HolderSet<Block>> param4, Vec3 param5, LevelBasedValue param6, boolean param7, Level.ExplosionInteraction param8, ParticleOptions param9, ParticleOptions param10, WeightedList<ExplosionParticleInfo> param11, Holder<SoundEvent> param12) {
      super();
   ...
   public void apply(ServerLevel var1, int var2, EnchantedItemInUse var3, Entity var4, Vec3 var5) {
      ...
      }), this.immuneBlocks), var6.x(), var6.y(), var6.z(), Math.max(this.radius.calculate(var2), 0.0F), this.createFire, this.blockInteraction, this.smallParticle, this.largeParticle, this.blockParticles, this.sound);
   }
