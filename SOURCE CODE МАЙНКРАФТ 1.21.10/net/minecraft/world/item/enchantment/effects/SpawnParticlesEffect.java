...
public record SpawnParticlesEffect(ParticleOptions particle, SpawnParticlesEffect.PositionSource horizontalPosition, SpawnParticlesEffect.PositionSource verticalPosition, SpawnParticlesEffect.VelocitySource horizontalVelocity, SpawnParticlesEffect.VelocitySource verticalVelocity, FloatProvider speed) implements EnchantmentEntityEffect {
   ...
   public SpawnParticlesEffect(ParticleOptions param1, SpawnParticlesEffect.PositionSource param2, SpawnParticlesEffect.PositionSource param3, SpawnParticlesEffect.VelocitySource param4, SpawnParticlesEffect.VelocitySource param5, FloatProvider param6) {
      super();
      this.particle = var1;
   ...
   public static record PositionSource(SpawnParticlesEffect.PositionSourceType type, float offset, float scale) {
      public static final MapCodec<SpawnParticlesEffect.PositionSource> CODEC = RecordCodecBuilder.mapCodec((var0) -> {
         return var0.group(SpawnParticlesEffect.PositionSourceType.CODEC.fieldOf("type").forGetter(SpawnParticlesEffect.PositionSource::type), Codec.FLOAT.optionalFieldOf("offset", 0.0F).forGetter(SpawnParticlesEffect.PositionSource::offset), ExtraCodecs.POSITIVE_FLOAT.optionalFieldOf("scale", 1.0F).forGetter(SpawnParticlesEffect.PositionSource::scale)).apply(var0, SpawnParticlesEffect.PositionSource::new);
      }).validate((var0) -> {
      ...
      public PositionSource(SpawnParticlesEffect.PositionSourceType param1, float param2, float param3) {
         super();
         this.type = var1;
         this.offset = var2;
         this.scale = var3;
      ...
      public SpawnParticlesEffect.PositionSourceType type() {
         return this.type;
      }
   ...
   public static record VelocitySource(float movementScale, FloatProvider base) {
      public static final MapCodec<SpawnParticlesEffect.VelocitySource> CODEC = RecordCodecBuilder.mapCodec((var0) -> {
         return var0.group(Codec.FLOAT.optionalFieldOf("movement_scale", 0.0F).forGetter(SpawnParticlesEffect.VelocitySource::movementScale), FloatProvider.CODEC.optionalFieldOf("base", ConstantFloat.ZERO).forGetter(SpawnParticlesEffect.VelocitySource::base)).apply(var0, SpawnParticlesEffect.VelocitySource::new);
      });

      public VelocitySource(float param1, FloatProvider param2) {
         super();
   ...
   public static enum PositionSourceType implements StringRepresentable {
      ...
      BOUNDING_BOX("in_bounding_box", (var0, var2, var4, var5) -> {
         return var2 + (var5.nextDouble() - 0.5D) * (double)var4;
      });
      ...
      // $FF: synthetic method
      private static SpawnParticlesEffect.PositionSourceType[] $values() {
         return new SpawnParticlesEffect.PositionSourceType[]{ENTITY_POSITION, BOUNDING_BOX};
      }
