   ...
   public static class Serializer<T extends SingleItemRecipe> implements RecipeSerializer<T> {
      ...
      protected Serializer(SingleItemRecipe.Factory<T> var1) {
         ...
         this.codec = RecordCodecBuilder.mapCodec((var1x) -> {
            P3 var10000 = var1x.group(Codec.STRING.optionalFieldOf("group", "").forGetter(SingleItemRecipe::group), Ingredient.CODEC.fieldOf("ingredient").forGetter(SingleItemRecipe::input), ItemStack.STRICT_CODEC.fieldOf("result").forGetter(SingleItemRecipe::result));
