...
public class RecipeManager extends SimplePreparableReloadListener<RecipeMap> implements RecipeAccess {
   ...
   public void finalizeRecipeLoading(FeatureFlagSet var1) {
      ...
      List var3 = RECIPE_PROPERTY_SETS.entrySet().stream().map((var0) -> {
         return new RecipeManager.IngredientCollector((ResourceKey)var0.getKey(), (RecipeManager.IngredientExtractor)var0.getValue());
      }).toList();
   ...
   private static boolean isIngredientEnabled(FeatureFlagSet var0, Ingredient var1) {
      return var1.items().allMatch((var1x) -> {
   ...
   public RecipeManager.ServerDisplayInfo getRecipeFromDisplay(RecipeDisplayId var1) {
      int var2 = var1.index();
      return var2 >= 0 && var2 < this.allDisplays.size() ? (RecipeManager.ServerDisplayInfo)this.allDisplays.get(var2) : null;
   }
   ...
   private static RecipeManager.IngredientExtractor forSingleInput(RecipeType<? extends SingleItemRecipe> var0) {
      return (var1) -> {
         Optional var10000;
         if (var1.getType() == var0 && var1 instanceof SingleItemRecipe) {
            SingleItemRecipe var2 = (SingleItemRecipe)var1;
   ...
   public static record ServerDisplayInfo(RecipeDisplayEntry display, RecipeHolder<?> parent) {
      ...
      public ServerDisplayInfo(RecipeDisplayEntry param1, RecipeHolder<?> param2) {
         super();
         this.display = var1;
         this.parent = var2;
      }
