...
public record RecipeDisplayEntry(RecipeDisplayId id, RecipeDisplay display, OptionalInt group, RecipeBookCategory category, Optional<List<Ingredient>> craftingRequirements) {
   ...
   public RecipeDisplayEntry(RecipeDisplayId param1, RecipeDisplay param2, OptionalInt param3, RecipeBookCategory param4, Optional<List<Ingredient>> param5) {
      super();
      this.id = var1;
      this.display = var2;
      this.group = var3;
   ...
   public boolean canCraft(StackedItemContents var1) {
      return this.craftingRequirements.isEmpty() ? false : var1.canCraft((List)((List)this.craftingRequirements.get()), (StackedContents.Output)null);
   }
