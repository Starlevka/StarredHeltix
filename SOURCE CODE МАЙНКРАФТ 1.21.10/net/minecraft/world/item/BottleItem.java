...
public class BottleItem extends Item {
   ...
   public InteractionResult use(Level var1, Player var2, InteractionHand var3) {
      ...
      if (!var4.isEmpty()) {
         ...
         var1.playSound((Entity)null, var2.getX(), var2.getY(), var2.getZ(), (SoundEvent)SoundEvents.BOTTLE_FILL_DRAGONBREATH, SoundSource.NEUTRAL, 1.0F, 1.0F);
         ...
         if (var6.getType() == HitResult.Type.MISS) {
            ...
            if (var6.getType() == HitResult.Type.BLOCK) {
               ...
               if (var1.getFluidState(var7).is(FluidTags.WATER)) {
                  var1.playSound(var2, var2.getX(), var2.getY(), var2.getZ(), (SoundEvent)SoundEvents.BOTTLE_FILL, SoundSource.NEUTRAL, 1.0F, 1.0F);
