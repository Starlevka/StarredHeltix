...
public class Items {
   ...
   static {
      ...
      ACACIA_SHELF = registerBlock(Blocks.ACACIA_SHELF, (var0) -> {
         return var0.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
      });
      BAMBOO_SHELF = registerBlock(Blocks.BAMBOO_SHELF, (var0) -> {
         return var0.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
      });
      BIRCH_SHELF = registerBlock(Blocks.BIRCH_SHELF, (var0) -> {
         return var0.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
      });
      CHERRY_SHELF = registerBlock(Blocks.CHERRY_SHELF, (var0) -> {
         return var0.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
      });
      CRIMSON_SHELF = registerBlock(Blocks.CRIMSON_SHELF, (var0) -> {
         return var0.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
      });
      DARK_OAK_SHELF = registerBlock(Blocks.DARK_OAK_SHELF, (var0) -> {
         return var0.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
      });
      JUNGLE_SHELF = registerBlock(Blocks.JUNGLE_SHELF, (var0) -> {
         return var0.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
      });
      MANGROVE_SHELF = registerBlock(Blocks.MANGROVE_SHELF, (var0) -> {
         return var0.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
      });
      OAK_SHELF = registerBlock(Blocks.OAK_SHELF, (var0) -> {
         return var0.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
      });
      PALE_OAK_SHELF = registerBlock(Blocks.PALE_OAK_SHELF, (var0) -> {
         return var0.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
      });
      SPRUCE_SHELF = registerBlock(Blocks.SPRUCE_SHELF, (var0) -> {
         return var0.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
      });
      WARPED_SHELF = registerBlock(Blocks.WARPED_SHELF, (var0) -> {
         return var0.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
      });
      ...
      CARVED_PUMPKIN = registerBlock(Blocks.CARVED_PUMPKIN, (var0) -> {
         return Waypoint.addHideAttribute(var0).component(DataComponents.EQUIPPABLE, Equippable.builder(EquipmentSlot.HEAD).setSwappable(false).setCameraOverlay(ResourceLocation.withDefaultNamespace("misc/pumpkinblur")).build());
      });
      ...
      COPPER_TORCH = registerBlock(Blocks.COPPER_TORCH, (var0, var1) -> {
         return new StandingAndWallBlockItem(var0, Blocks.COPPER_WALL_TORCH, Direction.DOWN, var1);
      });
      ...
      COPPER_SHOVEL = registerItem("copper_shovel", (var0) -> {
         return new ShovelItem(ToolMaterial.COPPER, 1.5F, -3.0F, var0);
      });
      COPPER_PICKAXE = registerItem("copper_pickaxe", (new Item.Properties()).pickaxe(ToolMaterial.COPPER, 1.0F, -2.8F));
      COPPER_AXE = registerItem("copper_axe", (var0) -> {
         return new AxeItem(ToolMaterial.COPPER, 7.0F, -3.2F, var0);
      });
      COPPER_HOE = registerItem("copper_hoe", (var0) -> {
         return new HoeItem(ToolMaterial.COPPER, -1.0F, -2.0F, var0);
      });
      ...
      SKELETON_SKULL = registerBlock(Blocks.SKELETON_SKULL, (var0, var1) -> {
         return new StandingAndWallBlockItem(var0, Blocks.SKELETON_WALL_SKULL, Direction.DOWN, Waypoint.addHideAttribute(var1));
      ...
      WITHER_SKELETON_SKULL = registerBlock(Blocks.WITHER_SKELETON_SKULL, (var0, var1) -> {
         return new StandingAndWallBlockItem(var0, Blocks.WITHER_SKELETON_WALL_SKULL, Direction.DOWN, Waypoint.addHideAttribute(var1));
      ...
      PLAYER_HEAD = registerBlock(Blocks.PLAYER_HEAD, (var0, var1) -> {
         return new PlayerHeadItem(var0, Blocks.PLAYER_WALL_HEAD, Waypoint.addHideAttribute(var1));
      }, (new Item.Properties()).rarity(Rarity.UNCOMMON).equippableUnswappable(EquipmentSlot.HEAD));
      ZOMBIE_HEAD = registerBlock(Blocks.ZOMBIE_HEAD, (var0, var1) -> {
         return new StandingAndWallBlockItem(var0, Blocks.ZOMBIE_WALL_HEAD, Direction.DOWN, Waypoint.addHideAttribute(var1));
      }, (new Item.Properties()).rarity(Rarity.UNCOMMON).equippableUnswappable(EquipmentSlot.HEAD));
      CREEPER_HEAD = registerBlock(Blocks.CREEPER_HEAD, (var0, var1) -> {
         return new StandingAndWallBlockItem(var0, Blocks.CREEPER_WALL_HEAD, Direction.DOWN, Waypoint.addHideAttribute(var1));
      }, (new Item.Properties()).rarity(Rarity.UNCOMMON).equippableUnswappable(EquipmentSlot.HEAD));
      DRAGON_HEAD = registerBlock(Blocks.DRAGON_HEAD, (var0, var1) -> {
         return new StandingAndWallBlockItem(var0, Blocks.DRAGON_WALL_HEAD, Direction.DOWN, Waypoint.addHideAttribute(var1));
      ...
      PIGLIN_HEAD = registerBlock(Blocks.PIGLIN_HEAD, (var0, var1) -> {
         return new StandingAndWallBlockItem(var0, Blocks.PIGLIN_WALL_HEAD, Direction.DOWN, Waypoint.addHideAttribute(var1));
      }, (new Item.Properties()).rarity(Rarity.UNCOMMON).equippableUnswappable(EquipmentSlot.HEAD));
