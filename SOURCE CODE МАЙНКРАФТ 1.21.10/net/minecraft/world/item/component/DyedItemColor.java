...
public record DyedItemColor(int rgb) implements TooltipProvider {
   ...
   public DyedItemColor(int param1) {
      super();
      this.rgb = var1;
   }
   ...
   public static ItemStack applyDyes(ItemStack var0, List<DyeItem> var1) {
      if (!var0.is(ItemTags.DYEABLE)) {
         ...
         int var14;
         for(Iterator var15 = var1.iterator(); var15.hasNext(); ++var7) {
            DyeItem var16 = (DyeItem)var15.next();
            var11 = var16.getDyeColor().getTextureDiffuseColor();
         ...
         var10 = var4 / var7;
         var11 = var5 / var7;
         float var17 = (float)var6 / (float)var7;
         float var18 = (float)Math.max(var9, Math.max(var10, var11));
         var9 = (int)((float)var9 * var17 / var18);
         var10 = (int)((float)var10 * var17 / var18);
         var11 = (int)((float)var11 * var17 / var18);
