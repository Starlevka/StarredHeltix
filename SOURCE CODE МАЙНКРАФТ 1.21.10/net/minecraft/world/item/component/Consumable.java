...
public record Consumable(float consumeSeconds, ItemUseAnimation animation, Holder<SoundEvent> sound, boolean hasConsumeParticles, List<ConsumeEffect> onConsumeEffects) {
   ...
   public Consumable(float param1, ItemUseAnimation param2, Holder<SoundEvent> param3, boolean param4, List<ConsumeEffect> param5) {
      super();
   ...
   public void emitParticlesAndSounds(RandomSource var1, LivingEntity var2, ItemStack var3, int var4) {
      ...
      SoundEvent var10000;
      if (var2 instanceof Consumable.OverrideConsumeSound) {
         Consumable.OverrideConsumeSound var12 = (Consumable.OverrideConsumeSound)var2;
   ...
   public static class Builder {
      ...
      public Consumable.Builder consumeSeconds(float var1) {
         this.consumeSeconds = var1;
         return this;
      }

      public Consumable.Builder animation(ItemUseAnimation var1) {
         this.animation = var1;
         return this;
      }

      public Consumable.Builder sound(Holder<SoundEvent> var1) {
         this.sound = var1;
         return this;
      }

      public Consumable.Builder soundAfterConsume(Holder<SoundEvent> var1) {
         return this.onConsume(new PlaySoundConsumeEffect(var1));
      }

      public Consumable.Builder hasConsumeParticles(boolean var1) {
         this.hasConsumeParticles = var1;
         return this;
      }

      public Consumable.Builder onConsume(ConsumeEffect var1) {
