...
public record UseRemainder(ItemStack convertInto) {
   ...
   public UseRemainder(ItemStack param1) {
      super();
      this.convertInto = var1;
   }

   public ItemStack convertIntoRemainder(ItemStack var1, int var2, boolean var3, UseRemainder.OnExtraCreatedRemainder var4) {
      if (var3) {
         return var1;
