...
public record PlaySoundConsumeEffect(Holder<SoundEvent> sound) implements ConsumeEffect {
   ...
   public PlaySoundConsumeEffect(Holder<SoundEvent> param1) {
      super();
      this.sound = var1;
   }
   ...
   public boolean apply(Level var1, ItemStack var2, LivingEntity var3) {
      var1.playSound((Entity)null, (BlockPos)var3.blockPosition(), (SoundEvent)this.sound.value(), var3.getSoundSource(), 1.0F, 1.0F);
      return true;
   }
