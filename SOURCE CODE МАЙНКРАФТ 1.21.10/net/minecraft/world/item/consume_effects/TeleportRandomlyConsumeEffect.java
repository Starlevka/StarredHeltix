...
public record TeleportRandomlyConsumeEffect(float diameter) implements ConsumeEffect {
   ...
   public TeleportRandomlyConsumeEffect(float param1) {
      super();
      this.diameter = var1;
   }
   ...
   public boolean apply(Level var1, ItemStack var2, LivingEntity var3) {
      ...
      for(int var5 = 0; var5 < 16; ++var5) {
         double var6 = var3.getX() + (var3.getRandom().nextDouble() - 0.5D) * (double)this.diameter;
         double var8 = Mth.clamp(var3.getY() + (var3.getRandom().nextDouble() - 0.5D) * (double)this.diameter, (double)var1.getMinY(), (double)(var1.getMinY() + ((ServerLevel)var1).getLogicalHeight() - 1));
         double var10 = var3.getZ() + (var3.getRandom().nextDouble() - 0.5D) * (double)this.diameter;
         if (var3.isPassenger()) {
            var3.stopRiding();
         }
      ...
      if (var4 && var3 instanceof Player) {
