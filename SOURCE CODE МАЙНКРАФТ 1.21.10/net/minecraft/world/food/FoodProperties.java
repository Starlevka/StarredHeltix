...
public record FoodProperties(int nutrition, float saturation, boolean canAlwaysEat) implements ConsumableListener {
   ...
   public FoodProperties(int param1, float param2, boolean param3) {
      super();
      this.nutrition = var1;
   ...
   public void onConsume(Level var1, LivingEntity var2, ItemStack var3, Consumable var4) {
      ...
      var1.playSound((Entity)null, var2.getX(), var2.getY(), var2.getZ(), (SoundEvent)((SoundEvent)var4.sound().value()), SoundSource.NEUTRAL, 1.0F, var5.triangle(1.0F, 0.4F));
      if (var2 instanceof Player) {
         Player var6 = (Player)var2;
         var6.getFoodData().eat(this);
         var1.playSound((Entity)null, var6.getX(), var6.getY(), var6.getZ(), (SoundEvent)SoundEvents.PLAYER_BURP, SoundSource.PLAYERS, 0.5F, Mth.randomBetween(var5, 0.9F, 1.0F));
      }
