...
public class GlCommandEncoder implements CommandEncoder {
   ...
   private boolean trySetup(GlRenderPass var1, Collection<String> var2) {
      if (!GlRenderPass.VALIDATION) {
         ...
         while(true) {
            if (!var3.hasNext()) {
               ...
               while(var3.hasNext()) {
                  Entry var33 = (Entry)var3.next();
                  if (var33.getValue() instanceof Uniform.Sampler) {
                     String var35 = (String)var33.getKey();
                     GlTextureView var6 = (GlTextureView)var1.samplers.get(var35);
                     if (var6 == null) {
                        throw new IllegalStateException("Missing sampler " + var35);
                     }

                     if (var6.isClosed()) {
                        throw new IllegalStateException("Sampler " + var35 + " (" + var6.texture().getLabel() + ") has been closed!");
                     }

                     if ((var6.texture().usage() & 4) == 0) {
                        throw new IllegalStateException("Sampler " + var35 + " (" + var6.texture().getLabel() + ") must have USAGE_TEXTURE_BINDING!");
                     }
                  }
               }
      ...
      RenderPipeline var32 = var1.pipeline.info();
      GlProgram var34 = var1.pipeline.program();
      this.applyPipelineState(var32);
      boolean var36 = this.lastProgram != var34;
      if (var36) {
         GlStateManager._glUseProgram(var34.getProgramId());
         this.lastProgram = var34;
      }

      Iterator var37 = var34.getUniforms().entrySet().iterator();

      while(var37.hasNext()) {
         Entry var7 = (Entry)var37.next();
         String var8 = (String)var7.getKey();
         boolean var9 = var1.dirtyUniforms.contains(var8);
         Uniform var10000 = (Uniform)var7.getValue();
         ...
         case 2:
            ...
            var22 = var43;
            int var21 = var22;
            GlTextureView var50 = (GlTextureView)var1.samplers.get(var8);
            if (var50 == null) {
               continue;
            }
            ...
            GlStateManager._texParameter(var24, 33084, var50.baseMipLevel());
            GlStateManager._texParameter(var24, 33085, var50.baseMipLevel() + var50.mipLevels() - 1);
