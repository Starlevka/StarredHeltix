...
public class DataFetcher {
   ...
   public class Subscription {
      ...
      public <T> void subscribe(DataFetcher.Task<T> var1, Consumer<T> var2) {
         DataFetcher.SubscribedTask var3 = DataFetcher.this.new SubscribedTask(DataFetcher.this, var1, var2);
   ...
   private class SubscribedTask<T> {
      ...
      SubscribedTask(final DataFetcher param1, final DataFetcher.Task param2, final Consumer param3) {
         super();
         this.task = var2;
         this.output = var3;
      }
   ...
   private static record SuccessfulComputationResult<T>(T value, long time) {
      ...
      SuccessfulComputationResult(T param1, long param2) {
         super();
         this.value = var1;
         this.time = var2;
      }
   ...
   private static record ComputationResult<T>(Either<T, Exception> value, long time) {
      ...
      ComputationResult(Either<T, Exception> param1, long param2) {
         super();
         this.value = var1;
         this.time = var2;
      }
