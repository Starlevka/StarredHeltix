...
public class RealmsSlotOptionsScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      CycleButton var5 = (CycleButton)this.addRenderableWidget(CycleButton.builder(Difficulty::getDisplayName).withValues((Collection)DIFFICULTIES).withInitialValue(this.difficulty).create(var1, row(1), this.columnWidth, 20, Component.translatable("options.difficulty"), (var1x, var2x) -> {
         this.difficulty = var2x;
      }));
      CycleButton var3 = (CycleButton)this.addRenderableWidget(CycleButton.builder(GameType::getShortDisplayName).withValues((Collection)GAME_MODES).withInitialValue(this.gameMode).create(this.column1X, row(3), this.columnWidth, 20, Component.translatable("selectWorld.gameMode"), (var1x, var2x) -> {
         this.gameMode = var2x;
      }));
