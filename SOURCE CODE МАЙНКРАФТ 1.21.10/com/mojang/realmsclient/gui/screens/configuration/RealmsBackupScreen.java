...
public class RealmsBackupScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.backupList = (RealmsBackupScreen.BackupObjectSelectionList)this.layout.addToContents(new RealmsBackupScreen.BackupObjectSelectionList(this));
   ...
   class BackupObjectSelectionList extends ContainerObjectSelectionList<RealmsBackupScreen.Entry> {
      ...
      public BackupObjectSelectionList(final RealmsBackupScreen param1) {
