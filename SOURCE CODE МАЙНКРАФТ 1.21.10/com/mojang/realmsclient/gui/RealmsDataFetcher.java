...
public class RealmsDataFetcher {
   ...
   public RealmsDataFetcher(RealmsClient var1) {
      ...
      this.serverListUpdateTask = this.dataFetcher.createTask("server list", () -> {
         ...
         return RealmsMainScreen.isSnapshot() ? new RealmsDataFetcher.ServerListData(var1x.servers, var1.listSnapshotEligibleRealms()) : new RealmsDataFetcher.ServerListData(var1x.servers, List.of());
   ...
   public static record ServerListData(List<RealmsServer> serverList, List<RealmsServer> availableSnapshotServers) {
      public ServerListData(List<RealmsServer> param1, List<RealmsServer> param2) {
         super();
